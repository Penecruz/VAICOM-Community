...
namespace VAICOM.Extensions.RIO
{
    ...
    public static partial class Commands
    {
        ...
        public static Dictionary<string, CommandInfo> all = new Dictionary<string, CommandInfo>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "wMsgJ_WPN_AG_SET_COMP_IP" ,       new CommandInfo { uniqueid = 23359, name = "wMsgJ_WPN_AG_SET_COMP_IP",       displayname = Labels.aicommands["wMsgJ_WPN_AG_SET_COMP_IP"], enabled = true       } },
            { "wMsgJ_WPN_AG_SET_MAN" ,           new CommandInfo { uniqueid = 23360, name = "wMsgJ_WPN_AG_SET_MAN",           displayname = Labels.aicommands["wMsgJ_WPN_AG_SET_MAN"], enabled = true           } },
            ...
            { "wMsgJ_UTIL_NAV_MAP_SPT_4" ,      new CommandInfo { uniqueid = 23508, name = "wMsgJ_UTIL_NAV_MAP_SPT_4",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MAP_SPT_4"], enabled = true } },
            { "wMsgJ_UTIL_NAV_MAP_SPT_5" ,      new CommandInfo { uniqueid = 23509, name = "wMsgJ_UTIL_NAV_MAP_SPT_5",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MAP_SPT_5"], enabled = true } },
            { "wMsgJ_UTIL_NAV_MAP_SPT_6" ,      new CommandInfo { uniqueid = 23510, name = "wMsgJ_UTIL_NAV_MAP_SPT_6",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MAP_SPT_6"], enabled = true } },
            { "wMsgJ_UTIL_NAV_MAP_SPT_7" ,      new CommandInfo { uniqueid = 23522, name = "wMsgJ_UTIL_NAV_MAP_SPT_7",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MAP_SPT_7"], enabled = true         } },
            { "wMsgJ_UTIL_NAV_MAP_SPT_8" ,      new CommandInfo { uniqueid = 23725, name = "wMsgJ_UTIL_NAV_MAP_SPT_8",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MAP_SPT_8"], enabled = true         } },
            { "wMsgJ_UTIL_NAV_MAP_SPT_9" ,      new CommandInfo { uniqueid = 23726, name = "wMsgJ_UTIL_NAV_MAP_SPT_9",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MAP_SPT_9"], enabled = true         } },
            { "wMsgJ_UTIL_NAV_MAP_SPT_10" ,     new CommandInfo { uniqueid = 23727, name = "wMsgJ_UTIL_NAV_MAP_SPT_10",     displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MAP_SPT_10"], enabled = true        } },
            { "wMsgJ_UTIL_NAV_MAP_SPT_11" ,     new CommandInfo { uniqueid = 23728, name = "wMsgJ_UTIL_NAV_MAP_SPT_11",     displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MAP_SPT_11"], enabled = true        } },
            { "wMsgJ_UTIL_NAV_MAP_SPT_12" ,     new CommandInfo { uniqueid = 23729, name = "wMsgJ_UTIL_NAV_MAP_SPT_12",     displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MAP_SPT_12"], enabled = true        } },
            { "wMsgJ_UTIL_NAV_MAP_SPT_13" ,     new CommandInfo { uniqueid = 23730, name = "wMsgJ_UTIL_NAV_MAP_SPT_13",     displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MAP_SPT_13"], enabled = true        } },
            { "wMsgJ_UTIL_NAV_MAP_SPT_14" ,     new CommandInfo { uniqueid = 23731, name = "wMsgJ_UTIL_NAV_MAP_SPT_14",     displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MAP_SPT_14"], enabled = true        } },
            ...
            { "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_1" ,      new CommandInfo { uniqueid = 23732, name = "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_1",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_1"], enabled = true } },
            { "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_2" ,      new CommandInfo { uniqueid = 23733, name = "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_2",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_2"], enabled = true } },
            { "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_3" ,      new CommandInfo { uniqueid = 23734, name = "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_3",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_3"], enabled = true } },
            { "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_4" ,      new CommandInfo { uniqueid = 23735, name = "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_4",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_4"], enabled = true } },
            { "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_5" ,      new CommandInfo { uniqueid = 23736, name = "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_5",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_5"], enabled = true } },
            { "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_6" ,      new CommandInfo { uniqueid = 23737, name = "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_6",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_6"], enabled = true } },
            { "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_7" ,      new CommandInfo { uniqueid = 23738, name = "wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_7",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_LOAD_FLT_PLAN_7"], enabled = true } },
            { "wMsgJ_UTIL_NAV_RELOAD_FLT_PLAN" ,      new CommandInfo { uniqueid = 23739, name = "wMsgJ_UTIL_NAV_RELOAD_FLT_PLAN",      displayname = Labels.aicommands["wMsgJ_UTIL_NAV_RELOAD_FLT_PLAN"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_1" ,            new CommandInfo { uniqueid = 23740, name = "wMsgJ_UTIL_NAV_DIR_SPT_1",            displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_1"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_2" ,            new CommandInfo { uniqueid = 23741, name = "wMsgJ_UTIL_NAV_DIR_SPT_2",            displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_2"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_3" ,            new CommandInfo { uniqueid = 23742, name = "wMsgJ_UTIL_NAV_DIR_SPT_3",            displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_3"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_4" ,            new CommandInfo { uniqueid = 23743, name = "wMsgJ_UTIL_NAV_DIR_SPT_4",            displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_4"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_5" ,            new CommandInfo { uniqueid = 23744, name = "wMsgJ_UTIL_NAV_DIR_SPT_5",            displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_5"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_6" ,            new CommandInfo { uniqueid = 23745, name = "wMsgJ_UTIL_NAV_DIR_SPT_6",            displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_6"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_7" ,            new CommandInfo { uniqueid = 23746, name = "wMsgJ_UTIL_NAV_DIR_SPT_7",            displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_7"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_8" ,            new CommandInfo { uniqueid = 23747, name = "wMsgJ_UTIL_NAV_DIR_SPT_8",            displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_8"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_9" ,            new CommandInfo { uniqueid = 23748, name = "wMsgJ_UTIL_NAV_DIR_SPT_9",            displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_9"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_10" ,           new CommandInfo { uniqueid = 23749, name = "wMsgJ_UTIL_NAV_DIR_SPT_10",           displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_10"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_11" ,           new CommandInfo { uniqueid = 23750, name = "wMsgJ_UTIL_NAV_DIR_SPT_11",           displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_11"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_12" ,           new CommandInfo { uniqueid = 23751, name = "wMsgJ_UTIL_NAV_DIR_SPT_12",           displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_12"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_13" ,           new CommandInfo { uniqueid = 23752, name = "wMsgJ_UTIL_NAV_DIR_SPT_13",           displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_13"], enabled = true } },
            { "wMsgJ_UTIL_NAV_DIR_SPT_14" ,           new CommandInfo { uniqueid = 23753, name = "wMsgJ_UTIL_NAV_DIR_SPT_14",           displayname = Labels.aicommands["wMsgJ_UTIL_NAV_DIR_SPT_14"], enabled = true } },
            { "wMsgJ_UTIL_NAV_MODE_EGI" ,             new CommandInfo { uniqueid = 23754, name = "wMsgJ_UTIL_NAV_MODE_EGI",             displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MODE_EGI"], enabled = true } },
            { "wMsgJ_UTIL_NAV_MODE_DEST" ,            new CommandInfo { uniqueid = 23755, name = "wMsgJ_UTIL_NAV_MODE_DEST",            displayname = Labels.aicommands["wMsgJ_UTIL_NAV_MODE_DEST"], enabled = true } },
            ...
            { "wMsgJ_DEF_MAN_PGM" ,             new CommandInfo { uniqueid = 23652, name = "wMsgJ_DEF_MAN_PGM",             displayname = Labels.aicommands["wMsgJ_DEF_MAN_PGM"], enabled = true            } },
            { "wMsgJ_DEF_MAN_PGM_1" ,           new CommandInfo { uniqueid = 23653, name = "wMsgJ_DEF_MAN_PGM_1",           displayname = Labels.aicommands["wMsgJ_DEF_MAN_PGM_1"], enabled = true          } },
            { "wMsgJ_DEF_MAN_PGM_2" ,           new CommandInfo { uniqueid = 23654, name = "wMsgJ_DEF_MAN_PGM_2",           displayname = Labels.aicommands["wMsgJ_DEF_MAN_PGM_2"], enabled = true          } },
            { "wMsgJ_DEF_MAN_PGM_3" ,           new CommandInfo { uniqueid = 23655, name = "wMsgJ_DEF_MAN_PGM_3",           displayname = Labels.aicommands["wMsgJ_DEF_MAN_PGM_3"], enabled = true          } },
            { "wMsgJ_DEF_MAN_PGM_4" ,           new CommandInfo { uniqueid = 23656, name = "wMsgJ_DEF_MAN_PGM_4",           displayname = Labels.aicommands["wMsgJ_DEF_MAN_PGM_4"], enabled = true          } },
            ...
            { "wMsgJ_DEF_CHF_PGM_R1_82" ,       new CommandInfo { uniqueid = 23616, name = "wMsgJ_DEF_CHF_PGM_R1_82",       displayname = Labels.aicommands["wMsgJ_DEF_CHF_PGM_R1_82"], enabled = true      } },
            { "wMsgJ_DEF_CMDS_IHBT_1" ,         new CommandInfo { uniqueid = 23657, name = "wMsgJ_DEF_CMDS_IHBT_1",         displayname = Labels.aicommands["wMsgJ_DEF_CMDS_IHBT_1"], enabled = true         } },
            { "wMsgJ_DEF_CMDS_IHBT_2" ,         new CommandInfo { uniqueid = 23658, name = "wMsgJ_DEF_CMDS_IHBT_2",         displayname = Labels.aicommands["wMsgJ_DEF_CMDS_IHBT_2"], enabled = true         } },
            { "wMsgJ_DEF_CMDS_IHBT_3" ,         new CommandInfo { uniqueid = 23659, name = "wMsgJ_DEF_CMDS_IHBT_3",         displayname = Labels.aicommands["wMsgJ_DEF_CMDS_IHBT_3"], enabled = true         } },
            { "wMsgJ_DEF_CMDS_IHBT_4" ,         new CommandInfo { uniqueid = 23660, name = "wMsgJ_DEF_CMDS_IHBT_4",         displayname = Labels.aicommands["wMsgJ_DEF_CMDS_IHBT_4"], enabled = true         } },
            { "wMsgJ_DEF_CMDS_IHBT_5" ,         new CommandInfo { uniqueid = 23661, name = "wMsgJ_DEF_CMDS_IHBT_5",         displayname = Labels.aicommands["wMsgJ_DEF_CMDS_IHBT_5"], enabled = true         } },
            { "wMsgJ_DEF_CMDS_IHBT_6" ,         new CommandInfo { uniqueid = 23662, name = "wMsgJ_DEF_CMDS_IHBT_6",         displayname = Labels.aicommands["wMsgJ_DEF_CMDS_IHBT_6"], enabled = true         } },
            { "wMsgJ_DEF_CMDS_IHBT_7" ,         new CommandInfo { uniqueid = 23663, name = "wMsgJ_DEF_CMDS_IHBT_7",         displayname = Labels.aicommands["wMsgJ_DEF_CMDS_IHBT_7"], enabled = true         } },
            ...
            { "wMsgJ_DEF_CMS_MOD_SBY" ,         new CommandInfo { uniqueid = 23649, name = "wMsgJ_DEF_CMS_MOD_SBY",             displayname = Labels.aicommands["wMsgJ_DEF_CMS_MOD_SBY"], enabled = true          } },
            { "wMsgJ_DEF_CMS_MOD_SEMI" ,        new CommandInfo { uniqueid = 23650, name = "wMsgJ_DEF_CMS_MOD_SEMI",            displayname = Labels.aicommands["wMsgJ_DEF_CMS_MOD_SEMI"], enabled = true         } },
            { "wMsgJ_DEF_CMS_MOD_BYP" ,         new CommandInfo { uniqueid = 23651, name = "wMsgJ_DEF_CMS_MOD_BYP",             displayname = Labels.aicommands["wMsgJ_DEF_CMS_MOD_BYP"], enabled = true          } },
