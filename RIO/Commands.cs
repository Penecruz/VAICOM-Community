...
namespace VAICOM.Extensions.RIO
{
    ...
    public static partial class Commands
    {
        ...
        public static Dictionary<string, CommandInfo> all = new Dictionary<string, CommandInfo>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "wMsgJ_RAD_159" ,                 new CommandInfo { uniqueid = 23500, name = "wMsgJ_RAD_159",                 displayname = Labels.aicommands["wMsgJ_RAD_159"]                    } },
            { "wMsgJ_RAD_159_USE_GUARD" ,       new CommandInfo { uniqueid = 23501, name = "wMsgJ_RAD_159_USE_GUARD",       displayname = Labels.aicommands["wMsgJ_RAD_159_USE_GUARD"]          } },
            { "wMsgJ_RAD_159_USE_MANUAL" ,      new CommandInfo { uniqueid = 23502, name = "wMsgJ_RAD_159_USE_MANUAL",      displayname = Labels.aicommands["wMsgJ_RAD_159_USE_MANUAL"]         } },
            { "wMsgJ_RAD_159_USE_CHAN" ,        new CommandInfo { uniqueid = 23503, name = "wMsgJ_RAD_159_USE_CHAN",        displayname = Labels.aicommands["wMsgJ_RAD_159_USE_CHAN"]           } },
            { "wMsgJ_RAD_159_USE_CHAN_1" ,      new CommandInfo { uniqueid = 23504, name = "wMsgJ_RAD_159_USE_CHAN_1",      displayname = Labels.aicommands["wMsgJ_RAD_159_USE_CHAN_1"]         } },
            { "wMsgJ_RAD_159_USE_CHAN_2" ,      new CommandInfo { uniqueid = 23505, name = "wMsgJ_RAD_159_USE_CHAN_2",      displayname = Labels.aicommands["wMsgJ_RAD_159_USE_CHAN_2"]         } },
            { "wMsgJ_RAD_159_USE_CHAN_3" ,      new CommandInfo { uniqueid = 23506, name = "wMsgJ_RAD_159_USE_CHAN_3",      displayname = Labels.aicommands["wMsgJ_RAD_159_USE_CHAN_3"]         } },
            { "wMsgJ_RAD_159_USE_CHAN_4" ,      new CommandInfo { uniqueid = 23507, name = "wMsgJ_RAD_159_USE_CHAN_4",      displayname = Labels.aicommands["wMsgJ_RAD_159_USE_CHAN_4"]         } },
            { "wMsgJ_RAD_159_USE_CHAN_5" ,      new CommandInfo { uniqueid = 23508, name = "wMsgJ_RAD_159_USE_CHAN_5",      displayname = Labels.aicommands["wMsgJ_RAD_159_USE_CHAN_5"]         } },
            { "wMsgJ_RAD_159_USE_CHAN_6" ,      new CommandInfo { uniqueid = 23509, name = "wMsgJ_RAD_159_USE_CHAN_6",      displayname = Labels.aicommands["wMsgJ_RAD_159_USE_CHAN_6"]         } },
            { "wMsgJ_RAD_159_USE_CHAN_7" ,      new CommandInfo { uniqueid = 23510, name = "wMsgJ_RAD_159_USE_CHAN_7",      displayname = Labels.aicommands["wMsgJ_RAD_159_USE_CHAN_7"]         } },
            { "wMsgJ_RAD_159_USE_CHAN_8" ,      new CommandInfo { uniqueid = 23511, name = "wMsgJ_RAD_159_USE_CHAN_8",      displayname = Labels.aicommands["wMsgJ_RAD_159_USE_CHAN_8"]         } },
            { "wMsgJ_RAD_159_TUNE_MAN" ,        new CommandInfo { uniqueid = 23512, name = "wMsgJ_RAD_159_TUNE_MAN",        displayname = Labels.aicommands["wMsgJ_RAD_159_TUNE_MAN"]           } },
            { "wMsgJ_RAD_159_SELECT_CHAN" ,     new CommandInfo { uniqueid = 23513, name = "wMsgJ_RAD_159_SELECT_CHAN",     displayname = Labels.aicommands["wMsgJ_RAD_159_SELECT_CHAN"]        } },
            { "wMsgJ_RAD_159_SELECT_MODE" ,     new CommandInfo { uniqueid = 23514, name = "wMsgJ_RAD_159_SELECT_MODE",     displayname = Labels.aicommands["wMsgJ_RAD_159_SELECT_MODE"]        } },
            { "wMsgJ_RAD_159_TUNE_ATC" ,        new CommandInfo { uniqueid = 23515, name = "wMsgJ_RAD_159_TUNE_ATC",        displayname = Labels.aicommands["wMsgJ_RAD_159_TUNE_ATC"]           } },
            { "wMsgJ_RAD_159_TUNE_TAC" ,        new CommandInfo { uniqueid = 23516, name = "wMsgJ_RAD_159_TUNE_TAC",        displayname = Labels.aicommands["wMsgJ_RAD_159_TUNE_TAC"]           } },

            { "wMsgJ_RAD_182" ,                 new CommandInfo { uniqueid = 23517, name = "wMsgJ_RAD_182",                 displayname = Labels.aicommands["wMsgJ_RAD_182"]           } },
            ...
            { "wMsgJ_RAD_182_USE_MANUAL" ,      new CommandInfo { uniqueid = 23519, name = "wMsgJ_RAD_182_USE_MANUAL",      displayname = Labels.aicommands["wMsgJ_RAD_182_USE_MANUAL"]          } },
            { "wMsgJ_RAD_182_USE_CHAN" ,        new CommandInfo { uniqueid = 23520, name = "wMsgJ_RAD_182_USE_CHAN",        displayname = Labels.aicommands["wMsgJ_RAD_182_USE_CHAN"]         } },
            { "wMsgJ_RAD_182_USE_CHAN_1 " ,     new CommandInfo { uniqueid = 23521, name = "wMsgJ_RAD_182_USE_CHAN_1 ",     displayname = Labels.aicommands["wMsgJ_RAD_182_USE_CHAN_1"]          } },
            { "wMsgJ_RAD_182_USE_CHAN_2" ,      new CommandInfo { uniqueid = 23522, name = "wMsgJ_RAD_182_USE_CHAN_2",      displayname = Labels.aicommands["wMsgJ_RAD_182_USE_CHAN_2"]          } },
            { "wMsgJ_RAD_182_USE_CHAN_3" ,      new CommandInfo { uniqueid = 23523, name = "wMsgJ_RAD_182_USE_CHAN_3",      displayname = Labels.aicommands["wMsgJ_RAD_182_USE_CHAN_3"]         } },
            { "wMsgJ_RAD_182_USE_CHAN_4" ,      new CommandInfo { uniqueid = 23524, name = "wMsgJ_RAD_182_USE_CHAN_4",      displayname = Labels.aicommands["wMsgJ_RAD_182_USE_CHAN_4"]          } },
            { "wMsgJ_RAD_182_USE_CHAN_5" ,      new CommandInfo { uniqueid = 23525, name = "wMsgJ_RAD_182_USE_CHAN_5",      displayname = Labels.aicommands["wMsgJ_RAD_182_USE_CHAN_5"]          } },
            { "wMsgJ_RAD_182_USE_CHAN_6" ,      new CommandInfo { uniqueid = 23526, name = "wMsgJ_RAD_182_USE_CHAN_6",      displayname = Labels.aicommands["wMsgJ_RAD_182_USE_CHAN_6"]           } },
            { "wMsgJ_RAD_182_USE_CHAN_7" ,      new CommandInfo { uniqueid = 23527, name = "wMsgJ_RAD_182_USE_CHAN_7",      displayname = Labels.aicommands["wMsgJ_RAD_182_USE_CHAN_7"]         } },
            { "wMsgJ_RAD_182_USE_CHAN_8" ,      new CommandInfo { uniqueid = 23528, name = "wMsgJ_RAD_182_USE_CHAN_8",      displayname = Labels.aicommands["wMsgJ_RAD_182_USE_CHAN_8"]           } },
            { "wMsgJ_RAD_182_TUNE_MAN" ,        new CommandInfo { uniqueid = 23529, name = "wMsgJ_RAD_182_TUNE_MAN",        displayname = Labels.aicommands["wMsgJ_RAD_182_TUNE_MAN"] } },
            { "wMsgJ_RAD_182_SELECT_CHAN" ,     new CommandInfo { uniqueid = 23530, name = "wMsgJ_RAD_182_SELECT_CHAN",     displayname = Labels.aicommands["wMsgJ_RAD_182_SELECT_CHAN"]   } },
            { "wMsgJ_RAD_182_SELECT_MODE" ,     new CommandInfo { uniqueid = 23531, name = "wMsgJ_RAD_182_SELECT_MODE",     displayname = Labels.aicommands["wMsgJ_RAD_182_SELECT_MODE"] } }, // use MODe below
            { "wMsgJ_RAD_182_TUNE_ATC" ,        new CommandInfo { uniqueid = 23532, name = "wMsgJ_RAD_182_TUNE_ATC",        displayname = Labels.aicommands["wMsgJ_RAD_182_TUNE_ATC"]  } },
            { "wMsgJ_RAD_182_TUNE_TAC" ,        new CommandInfo { uniqueid = 23533, name = "wMsgJ_RAD_182_TUNE_TAC",        displayname = Labels.aicommands["wMsgJ_RAD_182_TUNE_TAC"]  } },
