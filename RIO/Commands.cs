...
namespace VAICOM.Extensions.RIO
{
    ...
    public static partial class Commands
    {
        ...
        public static Dictionary<string, CommandInfo> all = new Dictionary<string, CommandInfo>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "wMsgJ_RDR_POS_L20" ,                 new CommandInfo { uniqueid = 23896, name = "wMsgJ_RDR_POS_L20",                 displayname = Labels.aicommands["wMsgJ_RDR_POS_L20"], enabled = true        } },
            { "wMsgJ_RDR_POS_R20" ,                 new CommandInfo { uniqueid = 23897, name = "wMsgJ_RDR_POS_R20",                 displayname = Labels.aicommands["wMsgJ_RDR_POS_R20"], enabled = true        } },
            { "wMsgJ_RDR_POS_L55" ,                 new CommandInfo { uniqueid = 23898, name = "wMsgJ_RDR_POS_L55",                 displayname = Labels.aicommands["wMsgJ_RDR_POS_L55"], enabled = true        } },
            { "wMsgJ_RDR_POS_R55" ,                 new CommandInfo { uniqueid = 23899, name = "wMsgJ_RDR_POS_R55",                 displayname = Labels.aicommands["wMsgJ_RDR_POS_R55"], enabled = true        } },
            ...
            { "wMsgJ_RDR_ELEV_CLOSE_LOW" ,          new CommandInfo { uniqueid = 23710, name = "wMsgJ_RDR_ELEV_CLOSE_LOW",          displayname = Labels.aicommands["wMsgJ_RDR_ELEV_CLOSE_LOW"], enabled = true  } },
            { "wMsgJ_RDR_ELEV_CLOSE_MID_LO" ,       new CommandInfo { uniqueid = 23711, name = "wMsgJ_RDR_ELEV_CLOSE_MID_LO",       displayname = Labels.aicommands["wMsgJ_RDR_ELEV_CLOSE_MID_LO"], enabled = true } },
            { "wMsgJ_RDR_ELEV_CLOSE_MID" ,          new CommandInfo { uniqueid = 23712, name = "wMsgJ_RDR_ELEV_CLOSE_MID",          displayname = Labels.aicommands["wMsgJ_RDR_ELEV_CLOSE_MID"], enabled = true } },
            { "wMsgJ_RDR_ELEV_CLOSE_MID_HI" ,       new CommandInfo { uniqueid = 23713, name = "wMsgJ_RDR_ELEV_CLOSE_MID_HI",       displayname = Labels.aicommands["wMsgJ_RDR_ELEV_CLOSE_MID_HI"], enabled = true } },
            { "wMsgJ_RDR_ELEV_CLOSE_HI" ,           new CommandInfo { uniqueid = 23714, name = "wMsgJ_RDR_ELEV_CLOSE_HI",           displayname = Labels.aicommands["wMsgJ_RDR_ELEV_CLOSE_HI"], enabled = true   } },
            { "wMsgJ_RDR_ELEV_MID_LOW" ,            new CommandInfo { uniqueid = 23715, name = "wMsgJ_RDR_ELEV_MID_LOW",            displayname = Labels.aicommands["wMsgJ_RDR_ELEV_MID_LOW"], enabled = true    } },
            { "wMsgJ_RDR_ELEV_MID_MID_LO" ,         new CommandInfo { uniqueid = 23716, name = "wMsgJ_RDR_ELEV_MID_MID_LO",         displayname = Labels.aicommands["wMsgJ_RDR_ELEV_MID_MID_LO"], enabled = true } },
            { "wMsgJ_RDR_ELEV_MID_MID" ,            new CommandInfo { uniqueid = 23717, name = "wMsgJ_RDR_ELEV_MID_MID",            displayname = Labels.aicommands["wMsgJ_RDR_ELEV_MID_MID"], enabled = true    } },
            { "wMsgJ_RDR_ELEV_MID_MID_HI" ,         new CommandInfo { uniqueid = 23718, name = "wMsgJ_RDR_ELEV_MID_MID_HI",         displayname = Labels.aicommands["wMsgJ_RDR_ELEV_MID_MID_HI"], enabled = true } },
            { "wMsgJ_RDR_ELEV_MID_HI" ,             new CommandInfo { uniqueid = 23719, name = "wMsgJ_RDR_ELEV_MID_HI",             displayname = Labels.aicommands["wMsgJ_RDR_ELEV_MID_HI"], enabled = true     } },
            { "wMsgJ_RDR_ELEV_LONG_LOW" ,           new CommandInfo { uniqueid = 23720, name = "wMsgJ_RDR_ELEV_LONG_LOW",           displayname = Labels.aicommands["wMsgJ_RDR_ELEV_LONG_LOW"], enabled = true   } },
            { "wMsgJ_RDR_ELEV_LONG_MID_LO" ,        new CommandInfo { uniqueid = 23721, name = "wMsgJ_RDR_ELEV_LONG_MID_LO",        displayname = Labels.aicommands["wMsgJ_RDR_ELEV_LONG_MID_LO"], enabled = true } },
            { "wMsgJ_RDR_ELEV_LONG_MID" ,           new CommandInfo { uniqueid = 23722, name = "wMsgJ_RDR_ELEV_LONG_MID",           displayname = Labels.aicommands["wMsgJ_RDR_ELEV_LONG_MID"], enabled = true   } },
            { "wMsgJ_RDR_ELEV_LONG_MID_HI" ,        new CommandInfo { uniqueid = 23723, name = "wMsgJ_RDR_ELEV_LONG_MID_HI",        displayname = Labels.aicommands["wMsgJ_RDR_ELEV_LONG_MID_HI"], enabled = true } },
            { "wMsgJ_RDR_ELEV_LONG_HI" ,            new CommandInfo { uniqueid = 23724, name = "wMsgJ_RDR_ELEV_LONG_HI",            displayname = Labels.aicommands["wMsgJ_RDR_ELEV_LONG_HI"], enabled = true    } },
