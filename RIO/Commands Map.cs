...
namespace VAICOM.Extensions.RIO
{
    ...
    public static partial class DeviceActionsLibrary
    {
        ...
        public partial class Sequences // strings using base commands
        {
            ...
            {"wMsgJ_UTIL_NAV_SEQ_AUTO",            new List<List<DeviceAction>> { }},
            {"wMsgJ_UTIL_NAV_SEQ_OFLY",            new List<List<DeviceAction>> { }},
            {"wMsgJ_UTIL_NAV_SEQ_MAN",             new List<List<DeviceAction>> { }},
            {"wMsgJ_UTIL_NAV_BHDI_FLY",            new List<List<DeviceAction>> { }},
            ...
            public static Dictionary<string, List<List<DeviceAction>>> AuxCommands = new Dictionary<string, List<List<DeviceAction>>>()
            {
                ...
                {"F-14BU:wMsgJ_UTIL_NAV_SEQ_AUTO", new List<List<DeviceAction>> { Macro.Seq_J_MENU_MAIN, Macro.Seq_J_UTIL_NAV_SEQ_AUTO_BU }},
                {"F-14BU:wMsgJ_UTIL_NAV_SEQ_OFLY", new List<List<DeviceAction>> { Macro.Seq_J_MENU_MAIN, Macro.Seq_J_UTIL_NAV_SEQ_OFLY_BU }},
                {"F-14BU:wMsgJ_UTIL_NAV_SEQ_MAN", new List<List<DeviceAction>> { Macro.Seq_J_MENU_MAIN, Macro.Seq_J_UTIL_NAV_SEQ_MAN_BU }},
                {"F-14BU:wMsgJ_UTIL_NAV_BHDI_FLY", new List<List<DeviceAction>> { Macro.Seq_J_MENU_MAIN, Macro.Seq_J_UTIL_NAV_BHDI_FLY_BU }},
