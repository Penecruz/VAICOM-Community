    ...
    namespace Static
    {
        ...
        public static class EditorCatLabels
        {
            ...
            public static Dictionary<CommandCategories, string> Commands = new Dictionary<CommandCategories, string>()
            {
                ...
                {CommandCategories.RIO_lantirn,            "F-14 AI RIO | LANTIRN"         },
                {CommandCategories.RIO_weapons,            "F-14 AI RIO | Weapons"         },
                {CommandCategories.RIO_radio,              "F-14 AI RIO | Radio"           },
                {CommandCategories.RIO_dlink,              "F-14 AI RIO | D-Link"          },
                {CommandCategories.RIO_utility,            "F-14 AI RIO | Nav/Utility"     },
                ...
                {CommandCategories.AH64D_George,           "AH-64D George AI"              },
                {CommandCategories.AH64D_George_CPG,       "AH-64D George AI | CP/G"       },
                {CommandCategories.AH64D_George_PLT,       "AH-64D George AI | Pilot"      },
