...
{combos = {{key = 'R',		reformers = {'LWin','LShift'}}},	down = device_commands.Action_10,	cockpit_device_id = 0,	value_down = 1.0,	name = _('Recorder On'),	category = _('Cheat')},
{combos = {{key = 'R',		reformers = {'LAlt','LShift'}}},	down = device_commands.Action_11,	cockpit_device_id = 0,	value_down = 1.0,	name = _('Recorder Off'),	category = _('Cheat')},
...
{combos = defaultDeviceAssignmentFor("plane_eject"),		down = iCommandPlaneEject,				name = _('Eject'),				category = _('Systems')},
{combos = {{key = 'P',	reformers = {'LShift'}}},			down = head_wrapper_commands.LockCrewBody,	cockpit_device_id = devices.HEAD_WRAPPER,	value_down = -1.0,	name = _('Lock crew body position'),	category = _('General')},

{combos = {{key = '1'}},	down = iCommandViewCockpitChangeSeat,	value_down = 1, name = _('Occupy Pilot Seat'),			category = _('View Cockpit')},
{combos = {{key = '2'}},	down = iCommandViewCockpitChangeSeat,	value_down = 2, name = _('Occupy Copilot/Gunner Seat'),	category = _('View Cockpit')},
...
-- Cockpit Mechanics ---------------------------
------------------------------------------------
{combos = {{key = 'C', reformers = {'LCtrl'}}},				down = cpt_mech_commands.MECH_Door_EXT,	cockpit_device_id = devices.CPT_MECH,	value_down = 1,	name = _('Open/Close Cockpit Door'),	category = {_('Systems')}},
...
-- Trimmer -------------------------------------
------------------------------------------------
{combos = {{key = 'T', reformers = {'LCtrl'}}},				down = iCommandPlaneTrimCancel,					name = _('Trimmer - Reset'),	category = {_('Trimmer'), _('Flight Control')}},

------------------------------------------------
-- Cyclic Stick --------------------------------
------------------------------------------------
{combos = defaultDeviceAssignmentFor("pitch_up"), down = iCommandPlaneDownStart,			up = iCommandPlaneDownStop,			name = _('Cyclic - Nose Down'),		category = {_('Cyclic Stick'), _('Flight Control')}},
{combos = defaultDeviceAssignmentFor("pitch_down"), down = iCommandPlaneUpStart,			up = iCommandPlaneUpStop,			name = _('Cyclic - Nose Up'),		category = {_('Cyclic Stick'), _('Flight Control')}},
{combos = defaultDeviceAssignmentFor("roll_left"), down = iCommandPlaneLeftStart,			up = iCommandPlaneLeftStop,			name = _('Cyclic - Bank Left'),		category = {_('Cyclic Stick'), _('Flight Control')}},
{combos = defaultDeviceAssignmentFor("roll_right"), down = iCommandPlaneRightStart,			up = iCommandPlaneRightStop,		name = _('Cyclic - Bank Right'),	category = {_('Cyclic Stick'), _('Flight Control')}},

------------------------------------------------
-- Ins Rudder ----------------------------------
------------------------------------------------
{combos = defaultDeviceAssignmentFor("rudder_left"), down = iCommandPlaneLeftRudderStart,	up = iCommandPlaneLeftRudderStop,	name = _('Rudder Left'),			category = {_('Rudder'), _('Flight Control')}},
{combos = defaultDeviceAssignmentFor("rudder_right"), down = iCommandPlaneRightRudderStart,	up = iCommandPlaneRightRudderStop,	name = _('Rudder Right'),			category = {_('Rudder'), _('Flight Control')}},

------------------------------------------------
-- Collective Stick ----------------------------
------------------------------------------------
{combos = {{key = '='}},				down = iCommandPlaneCollectiveIncrease,	up = iCommandPlaneCollectiveStop,	name = _('Collective - Up'),		category = {_('Collective Stick'), _('Flight Control')}},
{combos = {{key = '-'}},				down = iCommandPlaneCollectiveDecrease,	up = iCommandPlaneCollectiveStop,	name = _('Collective - Down'),		category = {_('Collective Stick'), _('Flight Control')}},
...
{combos = defaultDeviceAssignmentFor("fire"),							down = hotas_commands.CYCLIC_TRIGGER_2ND_DETENT,				up = hotas_commands.CYCLIC_TRIGGER_2ND_DETENT,				cockpit_device_id = devices.HOTAS_INPUT,	value_down =  1.0,	value_up = 0.0,	name = _('Weapons Trigger Switch - SECOND DETENT'),			category = {_('Cyclic Stick'), _('HOCAS')}},
...
{combos = {{key = '\\',		reformers = {'RAlt'}}},		down = hotas_commands.CYCLIC_RTS_SW_LEFT,						up = hotas_commands.CYCLIC_RTS_SW_LEFT,						cockpit_device_id = devices.HOTAS_INPUT,	value_down = -1.0,	value_up = 0.0,	name = _('PTT/RTS Switch - RADIO/Left (call radio menu)'),	category = {_('Cyclic Stick'), _('HOCAS'), _('Communications')}},
{combos = {{key = 'Space',	reformers = {'RShift'}}},	down = hotas_commands.CYCLIC_RTS_SW_RIGHT,						up = hotas_commands.CYCLIC_RTS_SW_RIGHT,					cockpit_device_id = devices.HOTAS_INPUT,	value_down =  1.0,	value_up = 0.0,	name = _('PTT/RTS Switch - ICS/Right (call radio menu)'),	category = {_('Cyclic Stick'), _('HOCAS'), _('Communications')}},
...
{combos = {{key = 'W',		reformers = {'LShift'}}},	down = hotas_commands.FLIGHT_TAIL_WHEEL_BTN,					up = hotas_commands.FLIGHT_TAIL_WHEEL_BTN,					cockpit_device_id = devices.HOTAS_INPUT,	value_down =  1.0,	value_up = 0.0,	name = _('Tail Wheel Lock/Unlock Button - Depress'),		category = {_('Collective Stick'), _('Flight Grip'), _('HOCAS')}},
...
---------------------------------------------
{combos = defaultDeviceAssignmentFor("thrust_up"),			down = iCommandThrottleIncrease,			up = iCommandThrottleStop,		name = _('Power Lever Smoothly (Both) - Increase'),		category = {_('Power Lever Quadrant'), _('Flight Control')}},
{combos = defaultDeviceAssignmentFor("thrust_down"),		down = iCommandThrottleDecrease,			up = iCommandThrottleStop,		name = _('Power Lever Smoothly (Both) - Decrease'),		category = {_('Power Lever Quadrant'), _('Flight Control')}},
{combos = {{key = 'Num+',		reformers = {'RAlt'}}},		down = iCommandThrottle1Increase,			up = iCommandThrottle1Stop,		name = _('Power Lever Smoothly (Left) - Increase'),		category = {_('Power Lever Quadrant'), _('Flight Control')}},
{combos = {{key = 'Num-',		reformers = {'RAlt'}}},		down = iCommandThrottle1Decrease,			up = iCommandThrottle1Stop,		name = _('Power Lever Smoothly (Left) - Decrease'),		category = {_('Power Lever Quadrant'), _('Flight Control')}},
{combos = {{key = 'Num+',		reformers = {'RShift'}}},	down = iCommandThrottle2Increase,			up = iCommandThrottle2Stop,		name = _('Power Lever Smoothly (Right) - Increase'),	category = {_('Power Lever Quadrant'), _('Flight Control')}},
{combos = {{key = 'Num-',		reformers = {'RShift'}}},	down = iCommandThrottle2Decrease,			up = iCommandThrottle2Stop,		name = _('Power Lever Smoothly (Right) - Decrease'),	category = {_('Power Lever Quadrant'), _('Flight Control')}},
{combos = {{key = 'PageUp'}},								down = iCommandPlaneAUTIncreaseRegime,										name = _('Power Lever Step (Both) - Increase'),			category = {_('Power Lever Quadrant'), _('Flight Control')}},
{combos = {{key = 'PageDown'}},								down = iCommandPlaneAUTDecreaseRegime,										name = _('Power Lever Step (Both) - Decrease'),			category = {_('Power Lever Quadrant'), _('Flight Control')}},
{combos = {{key = 'PageUp',		reformers = {'RAlt'}}},		down = iCommandPlaneAUTIncreaseRegimeLeft,									name = _('Power Lever Step (Left) - Increase'),			category = {_('Power Lever Quadrant'), _('Flight Control')}},
{combos = {{key = 'PageDown',	reformers = {'RAlt'}}},		down = iCommandPlaneAUTDecreaseRegimeLeft,									name = _('Power Lever Step (Left) - Decrease'),			category = {_('Power Lever Quadrant'), _('Flight Control')}},
{combos = {{key = 'PageUp',		reformers = {'RShift'}}},	down = iCommandPlaneAUTIncreaseRegimeRight,									name = _('Power Lever Step (Right) - Increase'),		category = {_('Power Lever Quadrant'), _('Flight Control')}},
{combos = {{key = 'PageDown',	reformers = {'RShift'}}},	down = iCommandPlaneAUTDecreaseRegimeRight,									name = _('Power Lever Step (Right) - Decrease'),		category = {_('Power Lever Quadrant'), _('Flight Control')}},
--
{combos = {{key = 'Home',		reformers = {'RAlt'}}},		down = iCommandLeftEngineStart,																						name = _('Power Lever (Left) - IDLE'),			category = {_('Power Lever Quadrant')}},
{combos = {{key = 'End',		reformers = {'RAlt'}}},		down = iCommandLeftEngineStop,																						name = _('Power Lever (Left) - OFF'),			category = {_('Power Lever Quadrant')}},
{combos = {{key = 'Home',		reformers = {'RShift'}}},	down = iCommandRightEngineStart,																					name = _('Power Lever (Right) - IDLE'),			category = {_('Power Lever Quadrant')}},
{combos = {{key = 'End',		reformers = {'RShift'}}},	down = iCommandRightEngineStop,																						name = _('Power Lever (Right) - OFF'),			category = {_('Power Lever Quadrant')}},
...
{combos = {{key = '0'}},									down = ctrl_commands.FingerLiftBoth_EXT,	up = ctrl_commands.FingerLiftBoth_EXT,	cockpit_device_id = devices.CONTROL_INTERFACE,	value_down =  1.0,		value_up = 0.0,	name = _('Power Lever Finger Lift (Both) - UP/DOWN'),					category = {_('Power Lever Quadrant')}},
...
-- both PLT and CPG
{combos = defaultDeviceAssignmentFor("wheel_brake"),							down = iCommandPlaneWheelBrakeOn,		up = iCommandPlaneWheelBrakeOff,		value_down = 1.0,	value_up = 0.0,		name = _('Wheel Brake - ON/OFF'),			category = _('Systems')},
{combos = defaultDeviceAssignmentFor("left_wheel_brake"),		down = iCommandPlaneWheelBrakeLeftOn,	up = iCommandPlaneWheelBrakeLeftOff,	value_down = 1.0,	value_up = 0.0,		name = _('Wheel Brake Left - ON/OFF'),		category = _('Systems')},
{combos = defaultDeviceAssignmentFor("right_wheel_brake"),		down = iCommandPlaneWheelBrakeRightOn,	up = iCommandPlaneWheelBrakeRightOff,	value_down = 1.0,	value_up = 0.0,		name = _('Wheel Brake Right - ON/OFF'),		category = _('Systems')},

------------------------------------------------
-- Keyboard Unit -------------------------------
------------------------------------------------
{combos = {{key = 'A',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyA,				up = KU_commands.keyA,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - A'),				category = _('Keyboard Unit')},
{combos = {{key = 'B',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyB,				up = KU_commands.keyB,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - B'),				category = _('Keyboard Unit')},
{combos = {{key = 'C',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyC,				up = KU_commands.keyC,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - C'),				category = _('Keyboard Unit')},
{combos = {{key = 'D',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyD,				up = KU_commands.keyD,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - D'),				category = _('Keyboard Unit')},
{combos = {{key = 'E',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyE,				up = KU_commands.keyE,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - E'),				category = _('Keyboard Unit')},
{combos = {{key = 'F',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyF,				up = KU_commands.keyF,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - F'),				category = _('Keyboard Unit')},
{combos = {{key = 'G',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyG,				up = KU_commands.keyG,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - G'),				category = _('Keyboard Unit')},
{combos = {{key = 'H',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyH,				up = KU_commands.keyH,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - H'),				category = _('Keyboard Unit')},
{combos = {{key = 'I',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyI,				up = KU_commands.keyI,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - I'),				category = _('Keyboard Unit')},
{combos = {{key = 'J',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyJ,				up = KU_commands.keyJ,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - J'),				category = _('Keyboard Unit')},
{combos = {{key = 'K',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyK,				up = KU_commands.keyK,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - K'),				category = _('Keyboard Unit')},
{combos = {{key = 'L',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyL,				up = KU_commands.keyL,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - L'),				category = _('Keyboard Unit')},
{combos = {{key = 'M',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyM,				up = KU_commands.keyM,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - M'),				category = _('Keyboard Unit')},
{combos = {{key = 'N',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyN,				up = KU_commands.keyN,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - N'),				category = _('Keyboard Unit')},
{combos = {{key = 'O',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyO,				up = KU_commands.keyO,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - O'),				category = _('Keyboard Unit')},
{combos = {{key = 'P',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyP,				up = KU_commands.keyP,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - P'),				category = _('Keyboard Unit')},
{combos = {{key = 'Q',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyQ,				up = KU_commands.keyQ,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - Q'),				category = _('Keyboard Unit')},
{combos = {{key = 'R',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyR,				up = KU_commands.keyR,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - R'),				category = _('Keyboard Unit')},
{combos = {{key = 'S',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyS,				up = KU_commands.keyS,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - S'),				category = _('Keyboard Unit')},
{combos = {{key = 'T',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyT,				up = KU_commands.keyT,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - T'),				category = _('Keyboard Unit')},
{combos = {{key = 'U',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyU,				up = KU_commands.keyU,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - U'),				category = _('Keyboard Unit')},
{combos = {{key = 'V',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyV,				up = KU_commands.keyV,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - V'),				category = _('Keyboard Unit')},
{combos = {{key = 'W',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyW,				up = KU_commands.keyW,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - W'),				category = _('Keyboard Unit')},
{combos = {{key = 'X',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyX,				up = KU_commands.keyX,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - X'),				category = _('Keyboard Unit')},
{combos = {{key = 'Y',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyY,				up = KU_commands.keyY,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - Y'),				category = _('Keyboard Unit')},
{combos = {{key = 'Z',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyZ,				up = KU_commands.keyZ,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - Z'),				category = _('Keyboard Unit')},
{combos = {{key = '/',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keySlash,			up = KU_commands.keySlash,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - /'),				category = _('Keyboard Unit')},

{combos = {{key = 'Num0',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.key0,				up = KU_commands.key0,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - 0'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num1',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.key1,				up = KU_commands.key1,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - 1'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num2',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.key2,				up = KU_commands.key2,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - 2'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num3',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.key3,				up = KU_commands.key3,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - 3'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num4',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.key4,				up = KU_commands.key4,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - 4'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num5',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.key5,				up = KU_commands.key5,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - 5'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num6',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.key6,				up = KU_commands.key6,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - 6'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num7',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.key7,				up = KU_commands.key7,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - 7'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num8',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.key8,				up = KU_commands.key8,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - 8'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num9',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.key9,				up = KU_commands.key9,					cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - 9'),				category = _('Keyboard Unit')},

{combos = {{key = '`',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keySign,				up = KU_commands.keySign,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - +/-'),			category = _('Keyboard Unit')},
{combos = {{key = '.',		reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyDot,				up = KU_commands.keyDot,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - .'),				category = _('Keyboard Unit')},

{combos = {{key = 'Num+',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyPlus,				up = KU_commands.keyPlus,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - +'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num-',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyMinus,			up = KU_commands.keyMinus,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - -'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num*',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyMultiply,			up = KU_commands.keyMultiply,			cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - *'),				category = _('Keyboard Unit')},
{combos = {{key = 'Num/',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyDivide,			up = KU_commands.keyDivide,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - / (divide)'),	category = _('Keyboard Unit')},

{combos = {{key = 'Enter',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyEnter,			up = KU_commands.keyEnter,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - ENTER'),			category = _('Keyboard Unit')},
{combos = {{key = 'Space',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.keySPC,				up = KU_commands.keySPC,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - SPC'),			category = _('Keyboard Unit')},
{combos = {{key = 'Back',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyBKS,				up = KU_commands.keyBKS,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - BKS'),			category = _('Keyboard Unit')},
{combos = {{key = 'Left',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyLeft,				up = KU_commands.keyLeft,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - Left'),			category = _('Keyboard Unit')},
{combos = {{key = 'Right',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyRight,			up = KU_commands.keyRight,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - Right'),			category = _('Keyboard Unit')},
{combos = {{key = 'Delete',	reformers = {'LCtrl','LWin'}}},		down = KU_commands.keyCLR,				up = KU_commands.keyCLR,				cockpit_device_id = devices.KU_INPUT,	value_down = 1.0,		value_up = 0.0,		name = _('KU Key - CLR'),			category = _('Keyboard Unit')},

{combos = {{key = 'Down',	reformers = {'LCtrl','LWin'}}},		pressed = KU_commands.BrightnessKnob_KB,										cockpit_device_id = devices.KU_INPUT,	value_pressed = -1.0,						name = _('KU Scratchpad Brightness Knob - CCW/Decrease'),	category = _('Keyboard Unit')},
{combos = {{key = 'Up',		reformers = {'LCtrl','LWin'}}},		pressed = KU_commands.BrightnessKnob_KB,										cockpit_device_id = devices.KU_INPUT,	value_pressed =  1.0,						name = _('KU Scratchpad Brightness Knob - CW/Increase'),	category = _('Keyboard Unit')},
...
-- Preston -------------------------------------
------------------------------------------------
{combos = {{key = 'C'}},						down = preston_commands.ControlRequest,											cockpit_device_id = devices.PrestonAI,	value_down = 1.0,					name = _('Request Aircraft Control'),					category = {_('George AI'), _('Multicrew')}},
{combos = {{key = 'V', reformers = {'LCtrl'}}},	down = preston_commands.ShowHideMenu,	up = preston_commands.ShowHideMenu,		cockpit_device_id = devices.PrestonAI,	value_down = 1.0,	value_up = 0,	name = _('George AI - Show/Hide'),						category = {_('George AI')}},
...
-- Kneeboard -----------------------------------
------------------------------------------------
{combos = {{key = '1', reformers = {'RShift','RAlt'}}},		down = DTU_commands.KB_FLARE_IterBurstCount,		cockpit_device_id = devices.DATA_TRANSFER_UNIT,		value_down = 1,	name = _('Change Flare Burst Count - 1/2/3/4/6/8'),						category = {_('Ground Adjustment')}},
{combos = {{key = '2', reformers = {'RShift','RAlt'}}},		down = DTU_commands.KB_FLARE_IterBurstInterval,		cockpit_device_id = devices.DATA_TRANSFER_UNIT,		value_down = 1,	name = _('Change Flare Burst Interval (sec) - 0.1/0.2/0.3/0.4'),		category = {_('Ground Adjustment')}},
{combos = {{key = '3', reformers = {'RShift','RAlt'}}},		down = DTU_commands.KB_FLARE_IterSalvoCount,		cockpit_device_id = devices.DATA_TRANSFER_UNIT,		value_down = 1,	name = _('Change Flare Salvo Count - 1/2/4/8/CONT'),					category = {_('Ground Adjustment')}},
{combos = {{key = '4', reformers = {'RShift','RAlt'}}},		down = DTU_commands.KB_FLARE_IterSalvoInterval,		cockpit_device_id = devices.DATA_TRANSFER_UNIT,		value_down = 1,	name = _('Change Flare Salvo Interval (sec) - 1/2/3/4/5/8/RAND'),		category = {_('Ground Adjustment')}},
{combos = {{key = '5', reformers = {'RShift','RAlt'}}},		down = DTU_commands.KB_FLARE_IterDelayTime,			cockpit_device_id = devices.DATA_TRANSFER_UNIT,		value_down = 1,	name = _('Change Flare Time Between Programs - 1/2/3/4/8'),				category = {_('Ground Adjustment')}},
