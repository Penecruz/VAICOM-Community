...
-- Receiver
innerNoise			= getInnerNoise(2.6E-6, 6)
frequency_accuracy 	= 40.0		--Hz
band_width			= 15000.0	--Hz 
power_low           = 2.5		-- Watt
power_norm 			= 10.0		-- Watt
power_high 			= 40		-- Watt
power_off  			= power_norm-- Watt
power	   			= power_norm-- Watt		
