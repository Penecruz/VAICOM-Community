...
AddTextTable("Preset_NAME",				10.0/28.0,		-0.008 + aspect,			{{"PresetTune"}}, 			nil, 				PRESET_TUNE)

AddText("Selected_0",					9.7/28.0,		aspect*6/7,					{{"PresetSelected", 0}}, 	"!")
AddText("Selected_1",					9.7/28.0,		aspect*5/7,					{{"PresetSelected", 1}}, 	"!")
AddText("Selected_2",					9.7/28.0,		aspect*4/7,					{{"PresetSelected", 2}}, 	"!")
AddText("Selected_3",					9.7/28.0,		aspect*3/7,					{{"PresetSelected", 3}}, 	"!")
AddText("Selected_4",					9.7/28.0,		aspect*2/7,					{{"PresetSelected", 4}}, 	"!")
AddText("Selected_5",					9.7/28.0,		aspect/7,					{{"PresetSelected", 5}}, 	"!")
AddText("Selected_6",					9.7/28.0,		0.0,						{{"PresetSelected", 6}}, 	"!")
AddText("Selected_7",					9.7/28.0,		-aspect/7,					{{"PresetSelected", 7}}, 	"!")
AddText("Selected_8",					9.7/28.0,		-aspect*2/7,				{{"PresetSelected", 8}}, 	"!")
AddText("Selected_9",					9.7/28.0,		-aspect*3/7,				{{"PresetSelected", 9}}, 	"!")

AddText("Name_0",						11.0/28.0,		aspect*6/7,					{{"PresetName", 0}}, 		nil)
AddText("Name_1",						11.0/28.0,		aspect*5/7,					{{"PresetName", 1}}, 		nil)
AddText("Name_2",						11.0/28.0,		aspect*4/7,					{{"PresetName", 2}}, 		nil)
AddText("Name_3",						11.0/28.0,		aspect*3/7,					{{"PresetName", 3}}, 		nil)
AddText("Name_4",						11.0/28.0,		aspect*2/7,					{{"PresetName", 4}}, 		nil)
AddText("Name_5",						11.0/28.0,		aspect/7,					{{"PresetName", 5}}, 		nil)
AddText("Name_6",						11.0/28.0,		0.0,						{{"PresetName", 6}}, 		nil)
AddText("Name_7",						11.0/28.0,		-aspect/7,					{{"PresetName", 7}}, 		nil)
AddText("Name_8",						11.0/28.0,		-aspect*2/7,				{{"PresetName", 8}}, 		nil)
AddText("Name_9",						11.0/28.0,		-aspect*3/7,				{{"PresetName", 9}}, 		nil)

AddText("Frequency_0",					20.0/28.0,		aspect*6/7,					{{"Preset", 0}}, 			nil)
AddText("Frequency_1",					20.0/28.0,		aspect*5/7,					{{"Preset", 1}}, 			nil)
AddText("Frequency_2",					20.0/28.0,		aspect*4/7,					{{"Preset", 2}}, 			nil)
AddText("Frequency_3",					20.0/28.0,		aspect*3/7,					{{"Preset", 3}}, 			nil)
AddText("Frequency_4",					20.0/28.0,		aspect*2/7,					{{"Preset", 4}}, 			nil)
AddText("Frequency_5",					20.0/28.0,		aspect/7,					{{"Preset", 5}}, 			nil)
AddText("Frequency_6",					20.0/28.0,		0.0,						{{"Preset", 6}}, 			nil)
AddText("Frequency_7",					20.0/28.0,		-aspect/7,					{{"Preset", 7}}, 			nil)
AddText("Frequency_8",					20.0/28.0,		-aspect*2/7,				{{"Preset", 8}}, 			nil)
AddText("Frequency_9",					20.0/28.0,		-aspect*3/7,				{{"Preset", 9}}, 			nil)
...
AddText("Symbols_6",					-10.0/28.0,		up + aspect*2/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_7",					-10.0/28.0,		up - 0.0025 + aspect/7,		nil, 						"|",				EUFD_stringdefs_vert_lines_)
...
AddText("Symbols_8",					9.311/28.0,		0.0125 + aspect,			nil, 						"$$$$$$$$$$$$$$",	EUFD_stringdefs_hor_lines)

AddText("Symbols_9",					9.0/28.0,		0.003 + aspect,				nil, 						"|",				EUFD_stringdefs_vert_lines_)
AddText("Symbols_10",					9.0/28.0,		up + aspect*6/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_11",					9.0/28.0,		up + aspect*5/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_12",					9.0/28.0,		up + aspect*4/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_13",					9.0/28.0,		up + aspect*3/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_14",					9.0/28.0,		up + aspect*2/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_15",					9.0/28.0,		up + aspect/7,				nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_16",					9.0/28.0,		up + 0.0,					nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_17",					9.0/28.0,		up - aspect/7,				nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_18",					9.0/28.0,		up - aspect*2/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_19",					9.0/28.0,		up - aspect*3/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)

AddText("Symbols_20",					9.311/28.0,		0.0225 - aspect*4/7,		nil, 						"$$$$$$$$$$$$$$",	EUFD_stringdefs_hor_lines)

AddText("Symbols_21",					27.0/28.0,		0.003 + aspect,				nil, 						"|",				EUFD_stringdefs_vert_lines_)
AddText("Symbols_22",					27.0/28.0,		up + aspect*6/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_23",					27.0/28.0,		up + aspect*5/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_24",					27.0/28.0,		up + aspect*4/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_25",					27.0/28.0,		up + aspect*3/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_26",					27.0/28.0,		up + aspect*2/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_27",					27.0/28.0,		up + aspect/7,				nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_28",					27.0/28.0,		up + 0.0,					nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_29",					27.0/28.0,		up - aspect/7,				nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_30",					27.0/28.0,		up - aspect*2/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
AddText("Symbols_31",					27.0/28.0,		up - aspect*3/7,			nil, 						"|",				EUFD_stringdefs_vert_lines)
