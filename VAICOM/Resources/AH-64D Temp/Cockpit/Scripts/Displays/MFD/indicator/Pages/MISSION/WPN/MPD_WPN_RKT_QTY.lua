...
Controls = 
{
	...
	{ pb.R1, "1",		tp_default_border,	{{"WPN_RKT_QTY_Selection",0}} },
	{ pb.R2, "2",		tp_default_border,	{{"WPN_RKT_QTY_Selection",1}} },
	{ pb.R3, "4",		tp_default_border,	{{"WPN_RKT_QTY_Selection",2}} },
	{ pb.R4, "8",		tp_default_border,	{{"WPN_RKT_QTY_Selection",3}} },
	{ pb.R5, "12",		tp_default_border,	{{"WPN_RKT_QTY_Selection",4}} },
	{ pb.R6, "24",		tp_default_border,	{{"WPN_RKT_QTY_Selection",5}} },
	{ pb.B6, "ALL",		tp_default_border,	{{"WPN_RKT_QTY_Selection",6}} },
}
...
verts_dn[3] = {pb_props[pb.B6].pos[1] - 3.0 * tp.width, pos_dn[2] - 2.5 * tp.height}
verts_dn[4] = {verts_dn[3][1], -display_size_pix_05}

local verts_bckgnd = createVertsForBackground(verts_r[1], verts_dn)
addTranslucentBackground( verts_bckgnd[1], default_box_indices, parent, nil, nil, TRANSPARENT_BACKGROUND )
addTranslucentBackground( verts_bckgnd[2], default_box_indices, parent, nil, nil, TRANSPARENT_BACKGROUND )
addTranslucentBackground( verts_bckgnd[3], default_box_indices, parent, nil, nil, TRANSPARENT_BACKGROUND )
addTranslucentBackground( verts_bckgnd[4], default_box_indices, parent, nil, nil, TRANSPARENT_BACKGROUND )
...
-- draw caption																		
for i = 1, #caption do
	addText( string.sub(caption, i, i).."\n", {pos_caption[1], pos_caption[2]}, tp, nil, nil, nil, nil, parent, h_clip_relations.INCREASE_LEVEL, DEFAULT_LEVEL, nil, TRANSPARENT_BACKGROUND )
