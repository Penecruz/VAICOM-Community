...
{		
	...
	{ pb.B2, { {"TUNE", nil }, {"STBY", tp_default_border , {{"MPD_COM_TuneTarget", 1}}, {"PRI", "STBY"} } } },
	{ "TUNE VHF", 
				{ 	
					{ pb.B4, 	"FH", nil, {{"MPD_COMM_TUNE_VHF", 1}}}, 
					{ pb.B5, 	"FH/M", nil, {{"MPD_COMM_TUNE_VHF", 2}}},  			
					{ pb.B6, 	"SC", nil, {{"MPD_COMM_TUNE_VHF", 3}}},     
				}  		
	},
}
