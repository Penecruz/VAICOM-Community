...
{			
	{ "CRYPTO",
				{					
					{ pb.R1,  {{"MODE",   nil, {{"MFD_COMM_FM_SET_Buttons", 0}}}, {"CIPHER", tp_default_border, {{"MFD_COMM_FM_SET_Buttons", 1}}, {"CIPHER", "PLAIN", "RECEIVE"}} } },					
					{ pb.R2,  {{"CNV",   nil, {{"MFD_COMM_FM_SET_Buttons", 0}}}, {"1", tp_default_border, {{"MFD_COMM_FM_SET_Buttons", 2}}, {"1", "2", "3", "4", "5", "6"}} } },	
				}
	},		
	{ pb.R5, {{"FM1 IFM",   nil, nil}, {"NORM", tp_default_border, {{"MFD_COMM_FM_SET_Buttons", 3}}, {"OFF", "LOW", "NORM", "HIGH"}} } },	
