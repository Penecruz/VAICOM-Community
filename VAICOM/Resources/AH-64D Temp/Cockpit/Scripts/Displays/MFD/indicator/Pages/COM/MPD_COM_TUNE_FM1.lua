...
--	{ pb.T1, {{"DAY", nil  },{ "1",	tp_default_border }}, nil  },	
	...
	{ pb.B2, { {"TUNE", nil }, {"STBY", tp_default_border , {{"MPD_COM_TuneTarget", 3}}, {"PRI", "STBY"} } } },
	{ "TUNE FM1", 
				{ 
					{ pb.B4, 	"FH", 	nil, {{"MPD_COMM_TUNE_FM1", 1}}},       
					{ pb.B5, 	"FH/M",	nil, {{"MPD_COMM_TUNE_FM1", 2}}},                    
					{ pb.B6, 	"SC", 	nil, {{"MPD_COMM_TUNE_FM1", 3}}},   
				}  		
	},
}
