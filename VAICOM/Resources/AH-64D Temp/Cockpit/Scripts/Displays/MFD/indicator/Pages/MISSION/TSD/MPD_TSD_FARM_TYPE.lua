...
Controls = 
{	
	{ pb.B6, "BASIC",		tp_default_border,	{{"TSD_FARM_TYPEMenu_Selection", FARM_REPORTS_TYPES.BASIC}}},
	{ pb.R6, "MSL",			tp_default_border,	{{"TSD_FARM_TYPEMenu_Selection", FARM_REPORTS_TYPES.MSL}}},
	{ pb.R5, "EXPEN",		tp_default_border,	{{"TSD_FARM_TYPEMenu_Selection", FARM_REPORTS_TYPES.EXPEN}}},
	{ pb.R4, "PP",			tp_default_border,	{{"TSD_FARM_TYPEMenu_Selection", FARM_REPORTS_TYPES.PP}}},
}
...
local pos_up, pos_dn = pb_props[pb.R4].pos, { pb_props[pb.R6].pos[1], pb_props[pb.R6].pos[2] - 75 }

local max_len = 6 * tp.width
