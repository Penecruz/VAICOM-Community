...
if MFD_NUM < MFD_SELF_IDS.CPG_LMFD then 			-- PLT
	UniqControls = 
	{
		{ pb.L4, "}PNVS",		nil,	{{"WPN_UTIL_PNVS_Enable"}}, 	{"{PNVS",	"}PNVS"}	},
	
		{ pb.L5, { {"EOCCM", nil, nil}, {"CLEAR", tp_default_border, {{"WPN_UTIL_EOCCM_Selection"}}, {"FILTER 1","CLEAR","FILTER 2"}} } },
	...
	UniqControls = 
	{
		{ pb.L4, "}TADS",		nil,	{{"WPN_UTIL_TADS_Enable"}}, 	{"{TADS",	"}TADS"}	},
		{ pb.L5, "}FLIR",		nil,	{{"WPN_UTIL_FLIR_Enable"}}, 	{"{FLIR",	"}FLIR"}	},
		{ pb.L6, "}LASER",		nil,	{{"WPN_UTIL_LASER_Enable"}}, 	{"{LASER",	"}LASER"}	},
	
		{ pb.R4, "TADS STOW",	tp_default_border, {{"WPN_UTIL_TADS_STOW_Frame"}} }
	}
end
