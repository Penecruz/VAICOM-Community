...
{		
	...
	{ pb.B2, { {"TUNE", nil }, {"STBY", tp_default_border , {{"MPD_COM_TuneTarget", 5}}, {"PRI", "STBY"} } } },
	{ "TUNE HF", 
				{ 
					{ pb.B3, 	"PRE", nil, {{"MPD_COMM_TUNE_HF", 1}}},     
					{ pb.B4, 	"ALE", nil, {{"MPD_COMM_TUNE_HF", 2}}},                           
					{ pb.B5, 	"ECCM",nil, {{"MPD_COMM_TUNE_HF", 3}}},  
					{ pb.B6, 	"SC",  nil, {{"MPD_COMM_TUNE_HF", 4}}}   					
				}  		
	},
}
