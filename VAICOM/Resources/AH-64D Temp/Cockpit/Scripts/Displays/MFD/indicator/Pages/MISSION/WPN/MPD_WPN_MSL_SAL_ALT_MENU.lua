...
addText( "WPN MSL ALT MENU",  {0, 410}, tp_36_white)
end
...
draw_border_with_caption( pb_props[pb.L1].pos_up, pb_props[pb.L5].pos,  6, 1, "ALTERNATE", pb_props[pb.L5].tp, nil, TRANSPARENT_BACKGROUND )
local Controls_Chan = {}
Controls_Chan = 
{
	-- just for frames around both string lines
	{ pb.L1, "   \n  ",	tp_border_nomargins,	{{"WPN_MSL_SAL_ALT_Channel_Selection",0}} }, 
	{ pb.L2, "   \n  ",	tp_border_nomargins,	{{"WPN_MSL_SAL_ALT_Channel_Selection",1}} },
	{ pb.L3, "   \n  ",	tp_border_nomargins,	{{"WPN_MSL_SAL_ALT_Channel_Selection",2}} },
	{ pb.L4, "   \n  ",	tp_border_nomargins,	{{"WPN_MSL_SAL_ALT_Channel_Selection",3}} },

	{ pb.L5, "NONE",	tp_default_border,		{{"WPN_MSL_SAL_ALT_Channel_Selection",4}} },
}
...
for i=0,3 do
	...
	local controlItem = { pb_num, "ALT", controlItemParams, {{"WPN_MSL_SAL_Channels_Caption",i}}, {"PRI", "ALT", "CHAN "..i+1}}
	createControlItem( controlItem, nil, nil, nil, TRANSPARENT_BACKGROUND )

	controlItemParams.pos = pb_props[pb_num].pos_down
	
	controlItem = { pb_num, "B", controlItemParams, {{"WPN_MSL_SAL_ChannelsCodes_Caption",i}}, WPN_MSL_CODE_CHANNELS}
	createControlItem( controlItem, nil, nil, nil, TRANSPARENT_BACKGROUND )
end
