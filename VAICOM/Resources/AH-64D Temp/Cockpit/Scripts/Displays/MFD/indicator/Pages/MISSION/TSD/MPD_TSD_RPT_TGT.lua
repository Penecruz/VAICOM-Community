...
addText( "TSD RPT PAGE - TGT",  {0, 350}, tp_36_white)
end
...
Controls = 
{
	{ pb.L2, "TGT",		tp_default_border,	nil},
	{ pb.L4, "ALL",		tp_default_border,	{{"TSD_RPT_TGT_ModeSelection",1}}},
	{ pb.L5, "PRI",		tp_default_border,	{{"TSD_RPT_TGT_ModeSelection",0}}},
}
