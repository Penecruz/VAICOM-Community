...
{	
	...
	{ pb.B2, { {"TUNE", nil }, {"STBY", tp_default_border , {{"MPD_COM_TuneTarget", 4}}, {"PRI", "STBY"} } } },
	{ "TUNE FM2", 
				{ 
					{ pb.B4, 	"FH", 	nil, {{"MPD_COMM_TUNE_FM2", 1}}},       
					{ pb.B5, 	"FH/M",	nil, {{"MPD_COMM_TUNE_FM2", 2}}},                    
					{ pb.B6, 	"SC", 	nil, {{"MPD_COMM_TUNE_FM2", 3}}},   
				}  		
	},
}
