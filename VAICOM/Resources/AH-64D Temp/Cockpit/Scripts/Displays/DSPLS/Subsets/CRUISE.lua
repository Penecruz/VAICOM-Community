...
addStrokeText("BarometricOrInertialAltitude",	"5200",	STROKE_FNT_DFLT_100, "RightBottom",	{650, 500},  VideoAreaPH.name, {{"DSPLS_CRUISE_BaroOrInertAltitude"}})
...
addStrokeBankAngle("BankAngle", {0, 560}, BankAnglePH.name, nil)
