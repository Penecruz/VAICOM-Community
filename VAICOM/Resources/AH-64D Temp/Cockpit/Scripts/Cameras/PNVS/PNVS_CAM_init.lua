...
page_subsets = {}
page_subsets[MAP_SUBSET] = LockOn_Options.script_path.."Cameras/PNVS/PNVS_CAM_subset.lua"
...
BasePage	= LockOn_Options.script_path.."Cameras/PNVS/PNVS_CAM_subset.lua"
