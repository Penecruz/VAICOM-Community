...
page_subsets = {}
page_subsets[MAP_SUBSET] = LockOn_Options.script_path.."Cameras/TADS/TADS_CAM_subset.lua"
...
BasePage	= LockOn_Options.script_path.."Cameras/TADS/TADS_CAM_subset.lua"
