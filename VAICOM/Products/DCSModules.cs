    ...
    namespace Products
    {
        ...
        public static class DCSmodules
        {
            ...
            public static Dictionary<string, DCSmodule> LookupTable = new Dictionary<string, DCSmodule>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                {"AJS-37",  new DCSmodule() { Id ="AJS37",Name = "AJS-37",  Alias = "Viggen", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight2 ,Singlehotkey = false, Havedial = false, Theme = "NATO",      SpeechAlias = "A J S Thirty Seven"  } },
                ...
                {"C-101",   new DCSmodule() { Id ="C-101",Name = "C-101",   Alias = "Aviojet", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight2 ,Singlehotkey = true , Havedial = false, Theme = "NATO",      SpeechAlias = "C One Oh One" } },
                ...
                {"F-14AB" , new DCSmodule() { Id ="F-14", Name = "F-14AB",  Alias = "Tomcat", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Navy",      SpeechAlias = "F Fourteen", radiodelay =500, chnoffset = 0  } },
                ...
                {"I-16",    new DCSmodule() { Id ="I-16", Name = "I-16",  Alias = "", IsFC = false, ApxWpn = false, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight2 ,Singlehotkey = true,  Havedial = false, Theme = "Russia",    SpeechAlias = "Eye Sixteen"  } },
                {"J-11A" ,  new DCSmodule() { Id ="J-11A",Name = "J-11A",   Alias = "Shenyang", IsFC = true,  ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",    SpeechAlias = "Jay Eleven"} },
                {"JF-17",   new DCSmodule() { Id ="JF-17",Name = "JF-17",  Alias = "Thunder", IsFC = false, ApxWpn = true, ApxDir = true,   IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",      SpeechAlias = "J F Seventeen" } },
                {"KA-50",   new DCSmodule() { Id ="Ka-50",Name = "KA-50",   Alias = "BlackShark 3", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true,  Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true , Havedial = true,  Theme = "Russia",    SpeechAlias = "Black Shark" } },
                {"L-39C",   new DCSmodule() { Id ="L-39C",Name = "L-39C",   Alias = "Albatros", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true,  Havedial = false, Theme = "NATO",      SpeechAlias = "Albatros"   } },
                {"L-39ZA",  new DCSmodule() { Id ="L-39ZA",Name = "L-39ZA",  Alias = "Albatros", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true,  Havedial = false, Theme = "NATO",      SpeechAlias = "Albatros"   } },
                {"M-2000C", new DCSmodule() { Id ="M-2000C",Name = "Mirage", Alias = "2000C", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "RedFlag",   SpeechAlias = "Mirage Two Thousand C"} },
                {"Mi-24P",  new DCSmodule() { Id ="Mi-24P",Name = "Mi-24P",  Alias = "Hind", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true, Flightmenu = DcsClient.iCommandsequences.showflight2, Singlehotkey = true, UseSingleRadioSelection = true, Havedial = true, Theme = "Russia",    SpeechAlias = "Hind"  } },
                {"Mi-8MT",  new DCSmodule() { Id ="Mi-8MT",Name = "Mi-8MT",  Alias = "Magificent8", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true,  Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false , Havedial = true,  Theme = "Russia",    SpeechAlias = "M..Eye Eight" } },
                {"MiG-15Bis",new DCSmodule(){ Id ="MiG-15Bis",Name ="MiG-15Bis",Alias = "Fagot", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true,  Havedial = false, Theme = "Russia",    SpeechAlias = "Mig..Fifteen" } },
                {"MiG-19P", new DCSmodule() { Id ="MiG-19P", Name = "MiG-19P",  Alias = "Farmer", IsFC = false, ApxWpn = false, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight2 ,Singlehotkey = true,  Havedial = false, Theme = "Russia",    SpeechAlias = "Mig..Nineteen"  } },
                {"MiG-21Bis",new DCSmodule(){ Id ="MiG-21Bis",Name ="MiG-21Bis",Alias = "Fishbed", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false,  Havedial = false, Theme = "Russia",    SpeechAlias = "Mig Twenty One" } },
                {"MiG-29 Fulcrum" , new DCSmodule() { Id ="MiG-29 Fulcrum",Name = "MiG-29",  Alias = "Fulcrum", IsFC = false,  ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",    SpeechAlias = "Fulcrum"} },
                {"MiG-29" , new DCSmodule() { Id ="MiG-29",Name = "MiG-29",  Alias = "FC", IsFC = true,  ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",    SpeechAlias = "Mig Twenty Nine"} },
                ...
                {"SA342L",  new DCSmodule() { Id ="SA342L",Name = "SA342L",  Alias = "Gazelle", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true,  Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true,  Havedial = true,  Theme = "RedFlag",   SpeechAlias = "Gazelle"   } },
                {"SA342M",  new DCSmodule() { Id ="SA342M",Name = "SA342M",  Alias = "Gazelle", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true,  Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true,  Havedial = true,  Theme = "RedFlag",   SpeechAlias = "Gazelle"  } },
                ...
                {"SU-25",   new DCSmodule() { Id ="Su-25",Name = "SU-25",   Alias = "Frogfoot", IsFC = true,  ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",    SpeechAlias = "Sue..Twenty Five"} },
                {"SU-25T",  new DCSmodule() { Id ="Su-25T",Name = "SU-25T",  Alias = "Frogfoot", IsFC = true,  ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",    SpeechAlias = "Sue..Twenty Five Tee"} },
                {"Su-27",   new DCSmodule() { Id ="Su-27",Name = "Su-27",   Alias = "Flanker", IsFC = true,  ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",    SpeechAlias = "Sue..Twenty Seven" } },
                {"Su-33",   new DCSmodule() { Id ="Su-33",Name = "Su-33",   Alias = "Flanker-D", IsFC = true,  ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",    SpeechAlias = "Sue Thirty Three"  } },
                ...
                {"Yak-52",  new DCSmodule() { Id ="Yak-52",Name = "Yak-52",  Alias = "", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight2 ,Singlehotkey = true,  Havedial = false, Theme = "Russia",    SpeechAlias = "Yak Fifty Two"  } },


                // Vaicom Community Additions
                {"MB-339A",   new DCSmodule() { Id ="MB-339A",Name = "MB-339A", Alias = "", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true,  Havedial = false, Theme = "NATO", SpeechAlias = "M..Bee Three Three Nine"  } },
                {"Mirage-F1", new DCSmodule() { Id ="Mirage-F1",Name = "Mirage-", Alias = "F1", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false,  Havedial = false, Theme = "NATO", SpeechAlias = "F One"  } },
                ...
                {"KA-50-3",   new DCSmodule() { Id ="Ka-50_3",Name = "KA-50",   Alias = "BlackShark", IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true,  Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true , Havedial = true,  Theme = "Russia",    SpeechAlias = "Black Shark Three" } },
