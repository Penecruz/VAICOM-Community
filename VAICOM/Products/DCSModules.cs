    ...
    namespace Products
    {
        ...
        public static class DCSmodules
        {
            ...
            public static Dictionary<string, DCSmodule> LookupTable = new Dictionary<string, DCSmodule>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                {"C-130J",    new DCSmodule() { Id ="C-130J",Name = "C-130J", Alias = "Hercules", ProOnly = true, IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false,  Havedial = false, Theme = "NATO",   SpeechAlias = "Hercules"  } },
