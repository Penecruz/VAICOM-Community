    ...
    namespace Products
    {
        ...
        public static class DCSmodules
        {
            ...
            public static Dictionary<string, DCSmodule> LookupTable = new Dictionary<string, DCSmodule>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                {"F-5E-3",  new DCSmodule() { Id ="F-5E-3",Name = "F-5E",    Alias = "Tiger II",    ProOnly = true,  IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true,  Havedial = false, Theme = "Fallon",   SpeechAlias = "F Five E"  } }, // Includes F-5E Remastered
                {"F-5E-3_FC", new DCSmodule() { Id ="F-5E-3_FC",Name = "F-5E", Alias = "FC",    ProOnly = true,  IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true,  Havedial = false, Theme = "Fallon",   SpeechAlias = "F Five FC"  } }, //Add Flaming Cliffs version
                ...
                {"JF-17",   new DCSmodule() { Id ="JF-17",Name = "JF-17",  Alias = "Thunder",       ProOnly = true,  IsFC = false, ApxWpn = true, ApxDir = true,   IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",      SpeechAlias = "J F Seventeen" } },
                ...
                {"Mi-24P",  new DCSmodule() { Id ="Mi-24P",Name = "Mi-24P",  Alias = "Hind",     ProOnly = true,  IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true, Flightmenu = DcsClient.iCommandsequences.showflight2, Singlehotkey = true, UseSingleRadioSelection = true, Havedial = true, Theme = "Russia",    SpeechAlias = "Hind"  } },
                ...
                {"MiG-29 Fulcrum" , new DCSmodule() { Id ="MiG-29 Fulcrum",Name = "MiG-29",  Alias = "Fulcrum",      ProOnly = true,  IsFC = false,  ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",    SpeechAlias = "Fulcrum"} },
                {"MiG-29" , new DCSmodule() { Id ="MiG-29",Name = "MiG-29",  Alias = "FC",      ProOnly = true,  IsFC = true,  ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "Russia",    SpeechAlias = "Mig Twenty Nine"} },
                ...
                {"UH-1H",   new DCSmodule() { Id ="UH-1H",Name = "UH-1H",   Alias = "Huey",          ProOnly = false, IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true,  Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true , UseSingleRadioSelection = true, Havedial = true,  Theme = "RedFlag",   SpeechAlias = "Huey"} },
                ...
                {"CH-47F",    new DCSmodule() { Id ="CH-47Fbl1",Name = "CH-47F", Alias = "Chinook", ProOnly = true, IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true, UseSingleRadioSelection = true, Havedial = false, Theme = "Afghan",   SpeechAlias = "Chinook"  } },
                {"F4U-1D",    new DCSmodule() { Id ="F4U-1D",Name = "F4U-1D",Alias = "Corsair", ProOnly = true,  IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true , Havedial = true, Theme = "WWII",      SpeechAlias = "Corsair" } },                
                {"C-130J-30", new DCSmodule() { Id ="C-130J-30",Name = "C-130J-30", Alias = "Hercules", ProOnly = true, IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true, UseSingleRadioSelection = true, Havedial = false, Theme = "NATO",   SpeechAlias = "Hercules"  } },
                ...
                {"OH-6A",       new DCSmodule() { Id ="OH-6A",Name = "OH-6A",  Alias = "Loach", ProOnly = true,  IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true, Flightmenu = DcsClient.iCommandsequences.showflight2 ,Singlehotkey = false,  Havedial = true, Theme = "Afghan",    SpeechAlias = "Loach"  } },
                {"AH-6J",       new DCSmodule() { Id ="AH-6J",Name = "AH-6J",  Alias = "Little Bird", ProOnly = true,  IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true, Flightmenu = DcsClient.iCommandsequences.showflight2 ,Singlehotkey = true,  Havedial = true, Theme = "Afghan",    SpeechAlias = "Little Bird"  } },
                {"MH-6J",       new DCSmodule() { Id ="MH-6J",Name = "MH-6J",  Alias = "Little Bird", ProOnly = true,  IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true, Flightmenu = DcsClient.iCommandsequences.showflight2 ,Singlehotkey = true,  Havedial = true, Theme = "Afghan",    SpeechAlias = "Little Bird"  } },
