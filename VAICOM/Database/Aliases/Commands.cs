    ...
    namespace Database
    {
        ...
        public static partial class Aliases
        {
            ...
            public static Dictionary<string, string> aicommands = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "George Hold Up",                 "georgeuplong"              },
                { "George Weapons Free",            "georgeweaponsfree"         },
                { "George Hold Fire",               "georgeholdfire"            },
                { "George Check Fire",              "georgeholdfire"            },
                { "George Hold Down",               "georgedownlong"            },
                { "George Hold Left",               "georgeleftlong"            },
                { "George Hold Right",              "georgerightlong"           },
                { "George Hold Select",             "georgecenterlong"          },
                { "George Hold Center",             "georgecenterlong"          },
                ...
                { "George Missile Profile",         "georgemsltraj"             },
                { "George Missile Path",            "georgemsltraj"             },
                ...
                { "George Search Steerpoint",       "georgepointsearch"         },
