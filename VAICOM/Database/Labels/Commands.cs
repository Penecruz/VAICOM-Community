    ...
    namespace Database
    {
        ...
        public static partial class Labels
        {
            ...
            public static Dictionary<string, string> aicommands = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "georgemenuopen",             "George Open Menu"              },
                { "georgemenuup",               "George Menu Up"                },
                { "georgemenudown",             "George Menu Down"              },
                { "georgemenuleft",             "George Menu Left"              },
                { "georgemenuright",            "George Menu Right"             },
                { "georgemenuselect",           "George Menu Select"            },
                { "georgemenuclose",            "George Close Menu"             },
                ...
                { "90leftgo",                   "90leftgo"                     },
                { "90rightgo",                  "90rightgo"                    },
                { "turnaboutleftgo",            "turnaboutleftgo"              },
                { "turnaboutrightgo",           "turnaboutrightgo"             },
                { "rotatego",                   "rotatego"                     },
                { "shacklego",                  "shacklego"                    },
                { "HeadingN",                   "HeadingN"                     },
                { "HeadingNE",                  "HeadingNE"                    },
                ...
                { "readyprecontact",    "Ready Precontact"          }, // can we do Ready Pre Contact??
