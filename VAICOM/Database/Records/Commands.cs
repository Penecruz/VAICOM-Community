...
namespace VAICOM
{
    namespace Database
    {
        ...
        public static partial class Commands
        {
            ...
            { "georgemenuopen" ,        new Command { uniqueid = 00006, category = CommandCategories.cockpit, eventnumber = 32001, dcsid = "iCommandGeorgeAI_ShowHideMenu", displayname = Labels.aicommands["georgemenuopen"], hasparameter = false } },
            { "georgemenuup" ,          new Command { uniqueid = 00007, category = CommandCategories.cockpit, eventnumber = 32002, dcsid = "iCommandGeorgeAI_HatUp", displayname = Labels.aicommands["georgemenuup"], hasparameter = false } },
            { "georgemenudown" ,        new Command { uniqueid = 00008, category = CommandCategories.cockpit, eventnumber = 32003, dcsid = "iCommandGeorgeAI_HatDown", displayname = Labels.aicommands["georgemenudown"], hasparameter = false } },
            { "georgemenuleft" ,        new Command { uniqueid = 00009, category = CommandCategories.cockpit, eventnumber = 32004, dcsid = "iCommandGeorgeAI_HatLeft", displayname = Labels.aicommands["georgemenuleft"], hasparameter = false } },
            { "georgemenuright" ,       new Command { uniqueid = 00010, category = CommandCategories.cockpit, eventnumber = 32005, dcsid = "iCommandGeorgeAI_HatRight", displayname = Labels.aicommands["georgemenuright"], hasparameter = false } },
            { "georgemenuselect" ,      new Command { uniqueid = 00011, category = CommandCategories.cockpit, eventnumber = 32006, dcsid = "iCommandGeorgeAI_MfInput", displayname = Labels.aicommands["georgemenuselect"], hasparameter = false } },
            { "georgemenuclose" ,       new Command { uniqueid = 00012, category = CommandCategories.cockpit, eventnumber = 32001, dcsid = "iCommandGeorgeAI_ShowHideMenu", displayname = Labels.aicommands["georgemenuclose"], hasparameter = false } },
