...
namespace VAICOM
{
    namespace Database
    {
        ...
        public static partial class Commands
        {
            ...
            { "raytarget" ,             new Command { uniqueid = 11016, category = CommandCategories.aicommsflightengage, dcsid = "wMsgLeaderRayTarget",             displayname = Labels.aicommands["raytarget"]} },
            ...
            // maneuver
            { "flightcheckin" ,         new Command { uniqueid = 11019, category = CommandCategories.aicommsflightmaneuver, dcsid = "wMsgLeaderFlightCheckIn",         displayname = Labels.aicommands["flightcheckin"]} },
            ...
            { "makerecon1" ,            new Command { uniqueid = 11039, category = CommandCategories.aicommsflightmaneuver, dcsid = "wMsgLeaderMakeRecon",             displayname = Labels.aicommands["makerecon1"], hasparameter = true, parameters = 1000  } },
            { "makerecon2" ,            new Command { uniqueid = 11040, category = CommandCategories.aicommsflightmaneuver, dcsid = "wMsgLeaderMakeRecon",             displayname = Labels.aicommands["makerecon2"], hasparameter = true, parameters = 2000 } },
            { "makerecon3" ,            new Command { uniqueid = 11041, category = CommandCategories.aicommsflightmaneuver, dcsid = "wMsgLeaderMakeRecon",             displayname = Labels.aicommands["makerecon3"], hasparameter = true, parameters = 3000 } },
            { "makerecon5" ,            new Command { uniqueid = 11042, category = CommandCategories.aicommsflightmaneuver, dcsid = "wMsgLeaderMakeRecon",             displayname = Labels.aicommands["makerecon5"], hasparameter = true, parameters = 5000  } },
            { "makerecon8" ,            new Command { uniqueid = 11043, category = CommandCategories.aicommsflightmaneuver, dcsid = "wMsgLeaderMakeRecon",             displayname = Labels.aicommands["makerecon8"], hasparameter = true, parameters = 8000 } },
            { "makerecon10" ,           new Command { uniqueid = 11044, category = CommandCategories.aicommsflightmaneuver, dcsid = "wMsgLeaderMakeRecon",             displayname = Labels.aicommands["makerecon10"],hasparameter = true, parameters = 10000 } },
            { "makereconatpoint" ,      new Command { uniqueid = 11045, category = CommandCategories.aicommsflightmaneuver, dcsid = "wMsgLeaderMakeReconAtPoint",      displayname = Labels.aicommands["makereconatpoint"]  } },
            ...
            { "fencein" ,               new Command { uniqueid = 11053, category = CommandCategories.aicommsflighttactical, dcsid = "wMsgLeaderFenceIn",               displayname = Labels.aicommands["fencein"] } },
            { "fenceout" ,              new Command { uniqueid = 11054, category = CommandCategories.aicommsflighttactical, dcsid = "wMsgLeaderFenceOut",              displayname = Labels.aicommands["fenceout"] } },
            { "out" ,                   new Command { uniqueid = 11055, category = CommandCategories.aicommsflighttactical, dcsid = "wMsgLeaderOut",                   displayname = Labels.aicommands["out"] } },
            ...
            { "closegroupformation" ,   new Command { uniqueid = 11065, category = CommandCategories.aicommsflightformation, dcsid = "wMsgLeaderCloseGroupFormation",   displayname = Labels.aicommands["closegroupformation"] } },
            ...
            { "helogotight" ,           new Command { uniqueid = 11073, category = CommandCategories.aicommsflightformation, dcsid = "wMsgLeaderHelGoTight",            displayname = Labels.aicommands["helogotight"] } },
            { "helogocruise" ,          new Command { uniqueid = 11074, category = CommandCategories.aicommsflightformation, dcsid = "wMsgLeaderHelGoCruise",           displayname = Labels.aicommands["helogocruise"] } },
            { "helogocombat" ,          new Command { uniqueid = 11075, category = CommandCategories.aicommsflightformation, dcsid = "wMsgLeaderHelGoCombat",           displayname = Labels.aicommands["helogocombat"] } },
            ...
            { "checkin" ,           new Command { uniqueid = 14001, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",           displayname = Labels.aicommands["checkin"] } },
            { "checkin05" ,         new Command { uniqueid = 14002, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin05"], hasparameter = true, parameters = 0300   } },
            { "checkin10" ,         new Command { uniqueid = 14003, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin10"], hasparameter = true, parameters = 0600   } },
            { "checkin15" ,         new Command { uniqueid = 14004, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin15"], hasparameter = true, parameters = 0900   } },
            { "checkin20" ,         new Command { uniqueid = 14005, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin20"], hasparameter = true, parameters = 1200   } },
            { "checkin25" ,         new Command { uniqueid = 14006, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin25"], hasparameter = true, parameters = 1500   } },
            { "checkin30" ,         new Command { uniqueid = 14007, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin30"], hasparameter = true, parameters = 1800   } },
            { "checkin35" ,         new Command { uniqueid = 14008, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin35"], hasparameter = true, parameters = 2100   } },
            { "checkin40" ,         new Command { uniqueid = 14009, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin40"], hasparameter = true, parameters = 2400   } },
            { "checkin45" ,         new Command { uniqueid = 14010, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin45"], hasparameter = true, parameters = 2700   } },
            { "checkin50" ,         new Command { uniqueid = 14011, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin50"], hasparameter = true, parameters = 3000   } },
            { "checkin55" ,         new Command { uniqueid = 14012, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin55"], hasparameter = true, parameters = 3300   } },
            { "checkin60" ,         new Command { uniqueid = 14013, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckIn",         displayname = Labels.aicommands["checkin60"], hasparameter = true, parameters = 3600   } },
            { "checkout" ,          new Command { uniqueid = 14014, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderCheckOut",          displayname = Labels.aicommands["checkout"] } },
            { "readytocopy" ,       new Command { uniqueid = 14015, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderReadyToCopy",       displayname = Labels.aicommands["readytocopy"] } },
            { "readyforremarks" ,   new Command { uniqueid = 14016, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderReadyToCopyRemarks",displayname = Labels.aicommands["readyforremarks"] } },
            { "ninelinereadback" ,  new Command { uniqueid = 14017, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader9LineReadback",     displayname = Labels.aicommands["ninelinereadback"], hasparameter = true, readback = true } },
            { "requesttasking" ,    new Command { uniqueid = 14018, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderRequestTasking",    displayname = Labels.aicommands["requesttasking"] } },
            { "requestbda" ,        new Command { uniqueid = 14019, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderRequestBDA",        displayname = Labels.aicommands["requestbda"] } },
            { "requesttargetdescr", new Command { uniqueid = 14020, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderRequestTargetDescription", displayname = Labels.aicommands["requesttargetdescr"] } },
            { "unabletocomply",     new Command { uniqueid = 14021, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderUnableToComply",    displayname = Labels.aicommands["unabletocomply"] } },
            //{ "repeat",             new Command { uniqueid = 14022, category = CommandCategories.aicommsjtac, eventnumber = 4000, name = "wMsgLeaderFACRepeat",         displayname = Labels.aicommands["repeat"] } }, // 4117 disabled, has bug
            
            { "ipinbound",          new Command { uniqueid = 14023, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_IP_INBOUND",       displayname = Labels.aicommands["ipinbound"] } },
            { "oneminute",          new Command { uniqueid = 14024, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_ONE_MINUTE",       displayname = Labels.aicommands["oneminute"] } },
            { "in",                 new Command { uniqueid = 14025, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_IN",               displayname = Labels.aicommands["in"] } },
            { "off",                new Command { uniqueid = 14026, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_OFF",              displayname = Labels.aicommands["off"] } },
            { "attackcomplete",     new Command { uniqueid = 14027, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_ATTACK_COMPLETE",  displayname = Labels.aicommands["attackcomplete"] } },
            { "advisereadyforbda",  new Command { uniqueid = 14028, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderAdviseWhenReadyToCopyBDA", displayname = Labels.aicommands["advisereadyforbda"] } },
            { "contact",            new Command { uniqueid = 14029, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderContact",           displayname = Labels.aicommands["contact"], hasparameter = true, parameters = 0 } }, // changed!
            { "nojoy",              new Command { uniqueid = 14030, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_NO_JOY",           displayname = Labels.aicommands["nojoy"] } },
            { "contactthemark",     new Command { uniqueid = 14031, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_CONTACT_the_mark", displayname = Labels.aicommands["contactthemark"] } },
            { "sparkle",            new Command { uniqueid = 14032, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_SPARKLE",          displayname = Labels.aicommands["sparkle"] } },
            { "snake",              new Command { uniqueid = 14033, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_SNAKE",            displayname = Labels.aicommands["snake"] } },
            { "pulse",              new Command { uniqueid = 14034, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_PULSE",            displayname = Labels.aicommands["pulse"] } },
            { "steady",             new Command { uniqueid = 14035, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_STEADY",           displayname = Labels.aicommands["steady"] } },
            { "rope",               new Command { uniqueid = 14036, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_ROPE",             displayname = Labels.aicommands["rope"] } },
            { "contactsparkle",     new Command { uniqueid = 14037, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_CONTACT_SPARKLE",  displayname = Labels.aicommands["contactsparkle"] } },
            { "stop",               new Command { uniqueid = 14038, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_STOP",             displayname = Labels.aicommands["stop"] } },
            { "tenseconds",         new Command { uniqueid = 14039, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_TEN_SECONDS",      displayname = Labels.aicommands["tenseconds"] } },
            { "laseron",            new Command { uniqueid = 14040, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_LASER_ON",         displayname = Labels.aicommands["laseron"] } },
            { "shift",              new Command { uniqueid = 14041, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_SHIFT",            displayname = Labels.aicommands["shift"] } },
            { "spot",               new Command { uniqueid = 14042, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_SPOT",             displayname = Labels.aicommands["spot"] } },
            { "terminate",          new Command { uniqueid = 14043, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeader_TERMINATE",        displayname = Labels.aicommands["terminate"] } },
            { "gunsgunsguns",       new Command { uniqueid = 14044, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderGuns",              displayname = Labels.aicommands["gunsgunsguns"] } },
            { "bombsaway",          new Command { uniqueid = 14045, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderBombsAway",         displayname = Labels.aicommands["bombsaway"] } },
            { "rifles",             new Command { uniqueid = 14046, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderRIFLE",             displayname = Labels.aicommands["rifles"] } },
            { "rockets",            new Command { uniqueid = 14047, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderRockets",           displayname = Labels.aicommands["rockets"] } },
            { "bda",                new Command { uniqueid = 14048, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderBDA",               displayname = Labels.aicommands["bda"] } },
            { "inflightrep",        new Command { uniqueid = 14049, category = CommandCategories.aicommsjtac, dcsid = "wMsgLeaderINFLIGHTREP",       displayname = Labels.aicommands["inflightrep"] } },
            ...
            { "reqtaxifortakeoff" ,     new Command { uniqueid = 15010, category = CommandCategories.aicommsatc, dcsid = "wMsgLeaderRequestTaxiForTakeoff", displayname = Labels.aicommands["reqtaxifortakeoff"] } },
            { "reqtaxitoparking" ,      new Command { uniqueid = 15011, category = CommandCategories.aicommsatc, dcsid = "wMsgLeaderRequestTaxiToParking",  displayname = Labels.aicommands["reqtaxitoparking"] } },
            { "towerreqtakeoff" ,       new Command { uniqueid = 15012, category = CommandCategories.aicommsatc, dcsid = "wMsgLeaderTowerRequestTakeOff",   displayname = Labels.aicommands["towerreqtakeoff"] } },
            { "inboundstraight" ,       new Command { uniqueid = 15013, category = CommandCategories.aicommsatc, dcsid = "wMsgLeaderInboundStraight",       displayname = Labels.aicommands["inboundstraight"]  } },
            { "approachoverhead" ,      new Command { uniqueid = 15014, category = CommandCategories.aicommsatc, dcsid = "wMsgLeaderApproachOverhead",      displayname = Labels.aicommands["approachoverhead"]  } },
            { "approachstraight" ,      new Command { uniqueid = 15015, category = CommandCategories.aicommsatc, dcsid = "wMsgLeaderApproachStraight",      displayname = Labels.aicommands["approachstraight"]  } },
            { "approachinstrument" ,    new Command { uniqueid = 15016, category = CommandCategories.aicommsatc, dcsid = "wMsgLeaderApproachInstrument",    displayname = Labels.aicommands["approachinstrument"]  } },

            // insert carrier ATC commands
            //{ "seeyouat10" ,            new Command { uniqueid = 15017, category = CommandCategories.aicommsatc, eventnumber = 4091, name = "wMsgLeaderApproachInstrument",    displayname = Labels.aicommands["approachinstrument"], requirescarrier = true } },
            ...
            { "requesthmd" ,                    new Command { uniqueid = 18004, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderSpecialCommand",displayname = Labels.aicommands["requesthmd"], hasparameter = true, type = 4, device = 0 } },
            { "requestnvg" ,                    new Command { uniqueid = 18005, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderSpecialCommand",displayname = Labels.aicommands["requestnvg"], hasparameter = true, type = 4, device = 1 } },
            { "loadwater" ,                     new Command { uniqueid = 18006, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderSpecialCommand",displayname = Labels.aicommands["loadwater"], hasparameter = true, volume = 1.0, device = 28 } },
            ...
            { "turboon" ,                       new Command { uniqueid = 18007, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderSpecialCommand",           displayname = Labels.aicommands["turboon"], hasparameter = true, type = 5, power_source = 0   } },
            { "turbooff" ,                      new Command { uniqueid = 18008, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderSpecialCommand",          displayname = Labels.aicommands["turbooff"], hasparameter = true, type = 5, power_source = 1 } },
            { "eppuon" ,                        new Command { uniqueid = 18009, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderSpecialCommand",            displayname = Labels.aicommands["eppuon"], hasparameter = true, parametername = "EPPU", value = true  } },
            ...
            { "requestrefueling" ,              new Command { uniqueid = 18011, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderRequestRefueling",      displayname = Labels.aicommands["requestrefueling"], hasparameter = true, volume = 1.0 } },
            { "requestcannonreload" ,           new Command { uniqueid = 18012, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderRequestCannonReloading",displayname = Labels.aicommands["requestcannonreload"] } },
            ...
            { "wheelchocksplace" ,              new Command { uniqueid = 18016, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderGroundToggleWheelChocks",      displayname = Labels.aicommands["wheelchocksplace"], hasparameter = true, on = true} },
            { "wheelchocksremove" ,             new Command { uniqueid = 18017, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderGroundToggleWheelChocks",     displayname = Labels.aicommands["wheelchocksremove"], hasparameter = true, on = false} },
            { "Seq_J_CANOPY_OPEN" ,             new Command { uniqueid = 18018, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderGroundToggleCanopy",            displayname = Labels.aicommands["Seq_J_CANOPY_OPEN"], hasparameter = true, close = true} }, // on = true
            { "Seq_J_CANOPY_CLOSE" ,            new Command { uniqueid = 18019, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderGroundToggleCanopy",           displayname = Labels.aicommands["Seq_J_CANOPY_CLOSE"], hasparameter = true, close = false } }, // on = false
            { "airsupplyconnect" ,              new Command { uniqueid = 18020, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderGroundToggleAir",      displayname = Labels.aicommands["airsupplyconnect"], hasparameter = true, on = true} },
            { "airsupplydisconnect" ,           new Command { uniqueid = 18021, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderGroundToggleAir",    displayname = Labels.aicommands["airsupplydisconnect"], hasparameter = true, on = false} },
            { "applyair" ,                      new Command { uniqueid = 18022, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderGroundApplyAir",        displayname = Labels.aicommands["applyair"], hasparameter = true, on = true } },
            { "requestrepair" ,                 new Command { uniqueid = 18023, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderGroundRepair",          displayname = Labels.aicommands["requestrepair"] } },

            // new for Supercarrier
            { "crewsalute" ,                    new Command { uniqueid = 18024, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderGroundGestureSalut",    displayname = Labels.aicommands["crewsalute"], hasparameter = true, on = true } }, // type is to be found out
            { "crewrequestcatlaunch" ,          new Command { uniqueid = 18025, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderGroundRequestLaunch",   displayname = Labels.aicommands["crewrequestcatlaunch"], hasparameter = true, on = true } }, // type is to be found out

            { "wMsgLeaderToGroundCrewMaximum" , new Command { uniqueid = 18030, category = CommandCategories.aicommscrew, dcsid = "wMsgLeaderToGroundCrewMaximum",   } },
            //service max
            { "wMsgLeaderMaximum" ,             new Command { uniqueid = 18035, category = CommandCategories.aicomms,     dcsid = "wMsgLeaderMaximum",               } },

            // navy carrier comms
            { "wMsgLeaderToNavyATCNull" ,       new Command { uniqueid = 18036, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderToNavyATCNull",         } },
            { "wMsgLeaderInboundCarrier" ,      new Command { uniqueid = 18037, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderInboundCarrier",        displayname = Labels.aicommands["wMsgLeaderInboundCarrier"] } },
            { "wMsgLeaderConfirm" ,             new Command { uniqueid = 18038, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderConfirm",               displayname = Labels.aicommands["wMsgLeaderConfirm"] } },
            { "wMsgLeaderConfirmRemainingFuel", new Command { uniqueid = 18039, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderConfirmRemainingFuel",  displayname = Labels.aicommands["wMsgLeaderConfirmRemainingFuel"] } },
            { "wMsgLeaderInboundMarshallRespond",new Command { uniqueid = 18040, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderInboundMarshallRespond",displayname = Labels.aicommands["wMsgLeaderInboundMarshallRespond"] } },
            { "wMsgLeaderEsteblished",          new Command { uniqueid = 18041, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderEstablished",           displayname = Labels.aicommands["wMsgLeaderEsteblished"] } },
            { "wMsgLeaderCommencing",           new Command { uniqueid = 18042, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderCommencing",            displayname = Labels.aicommands["wMsgLeaderCommencing"] } },
            { "wMsgLeaderCheckingIn",           new Command { uniqueid = 18043, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderCheckingIn",            displayname = Labels.aicommands["wMsgLeaderCheckingIn"] } },
            { "wMsgLeaderPlatform",             new Command { uniqueid = 18044, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderPlatform",              displayname = Labels.aicommands["wMsgLeaderPlatform"] } },
            { "wMsgLeaderSayNeedle",            new Command { uniqueid = 18045, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderSayNeedle",             displayname = Labels.aicommands["wMsgLeaderSayNeedle"] } },
            { "wMsgLeaderSeeYouAtTen",          new Command { uniqueid = 18046, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderSeeYouAtTen",           displayname = Labels.aicommands["wMsgLeaderSeeYouAtTen"] } },
            { "wMsgLeaderHornetBall",           new Command { uniqueid = 18047, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderHornetBall",            displayname = Labels.aicommands["wMsgLeaderHornetBall"] } },
            { "wMsgLeaderCLARA",                new Command { uniqueid = 18048, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderCLARA",                 displayname = Labels.aicommands["wMsgLeaderCLARA"] } },
            { "wMsgLeaderBall",                 new Command { uniqueid = 18049, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderBall",                  displayname = Labels.aicommands["wMsgLeaderBall"] } },
            { "wMsgLeaderTowerOverhead",        new Command { uniqueid = 18050, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderTowerOverhead",         displayname = Labels.aicommands["wMsgLeaderTowerOverhead"] } },
            { "wMsgLeaderFlightKissOff",        new Command { uniqueid = 18051, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderFlightKissOff",         displayname = Labels.aicommands["wMsgLeaderFlightKissOff"] } },
            { "wMsgLeaderAirborn",              new Command { uniqueid = 18052, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderAirborn",               displayname = Labels.aicommands["wMsgLeaderAirborn"] } },
            { "wMsgLeaderPassing2_5Kilo",       new Command { uniqueid = 18053, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderPassing2_5Kilo",        displayname = Labels.aicommands["wMsgLeaderPassing2_5Kilo"] } },

            { "wMsgLeaderToNavyATCMaximum" ,    new Command { uniqueid = 18060, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderToNavyATCMaximum",      } },
            // end carrier comms
            ...
            { "wMsgShowKneeboardTab",          new Command { uniqueid = 23004, category = CommandCategories.special, eventnumber = 4000, dcsid = "wMsgShowKneeboardTab",   displayname = Labels.aicommands["wMsgShowKneeboardTab"] } },
            ...
            // George AI device-control commands (AH-64D)
            ...
            { "georgeshowhide",               new Command { uniqueid = 23009, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeShowHide", displayname = Labels.aicommands["georgeshowhide"] } },
            { "georgeup",                     new Command { uniqueid = 23010, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeUp", displayname = Labels.aicommands["georgeup"] } },
            { "georgedown",                   new Command { uniqueid = 23011, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeDown", displayname = Labels.aicommands["georgedown"] } },
            { "georgeleft",                   new Command { uniqueid = 23012, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeLeft", displayname = Labels.aicommands["georgeleft"] } },
            { "georgeright",                  new Command { uniqueid = 23013, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeRight", displayname = Labels.aicommands["georgeright"] } },
            { "georgecenter",                 new Command { uniqueid = 23014, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeCenter", displayname = Labels.aicommands["georgecenter"] } },
            { "georgecontrolrequest",         new Command { uniqueid = 23015, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeControlRequest", displayname = Labels.aicommands["georgecontrolrequest"] } },
            { "georgestoretarget",            new Command { uniqueid = 23016, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeStoreTarget", displayname = Labels.aicommands["georgestoretarget"] } },
            { "georgeuplong",                 new Command { uniqueid = 23018, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeUpLong", displayname = Labels.aicommands["georgeuplong"] } },
            { "georgedownlong",               new Command { uniqueid = 23019, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeDownLong", displayname = Labels.aicommands["georgedownlong"] } },
            { "georgeleftlong",               new Command { uniqueid = 23020, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeLeftLong", displayname = Labels.aicommands["georgeleftlong"] } },
            { "georgerightlong",              new Command { uniqueid = 23021, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeRightLong", displayname = Labels.aicommands["georgerightlong"] } },
            { "georgecenterlong",             new Command { uniqueid = 23022, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeCenterLong", displayname = Labels.aicommands["georgecenterlong"] } },
            { "georgemacrophssearch",         new Command { uniqueid = 23023, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeMacroPHSsearch", displayname = Labels.aicommands["georgemacrophssearch"] } },
            { "georgemacrotadslos",           new Command { uniqueid = 23024, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeMacroTADSLOS", displayname = Labels.aicommands["georgemacrotadslos"] } },
            { "georgemacronextsearch",        new Command { uniqueid = 23025, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeMacroNextSearch", displayname = Labels.aicommands["georgemacronextsearch"] } },
            { "georgemacroprevioussearch",    new Command { uniqueid = 23026, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeMacroPreviousSearch", displayname = Labels.aicommands["georgemacroprevioussearch"] } },
            { "georgemacronextpoint",         new Command { uniqueid = 23027, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeMacroNextPoint", displayname = Labels.aicommands["georgemacronextpoint"] } },
            { "georgemacropreviouspoint",     new Command { uniqueid = 23028, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeMacroPreviousPoint", displayname = Labels.aicommands["georgemacropreviouspoint"] } },
            { "georgelasetarget",             new Command { uniqueid = 23030, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeLaseTarget", displayname = Labels.aicommands["georgelasetarget"] } },
            { "georgelaseron",                new Command { uniqueid = 23031, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeLaserOn", displayname = Labels.aicommands["georgelaseron"] } },
            { "georgelaseroff",               new Command { uniqueid = 23032, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeLaserOff", displayname = Labels.aicommands["georgelaseroff"] } },
            { "georgeburstlimit",             new Command { uniqueid = 23033, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeBurstLimit", displayname = Labels.aicommands["georgeburstlimit"] } },
            { "georgerocketquantity",         new Command { uniqueid = 23034, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeRocketQuantity", displayname = Labels.aicommands["georgerocketquantity"] } },
            { "georgelobl",                   new Command { uniqueid = 23035, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeLOBL", displayname = Labels.aicommands["georgelobl"] } },
            { "georgeloal",                   new Command { uniqueid = 23036, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeLOAL", displayname = Labels.aicommands["georgeloal"] } },
            { "georgenextweapon",             new Command { uniqueid = 23037, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeNextWeapon", displayname = Labels.aicommands["georgenextweapon"] } },
            { "georgeclearedfire",            new Command { uniqueid = 23038, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeClearedFire", displayname = Labels.aicommands["georgeclearedfire"] } },
            { "georgeweaponsfree",            new Command { uniqueid = 23039, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeWeaponsFree", displayname = Labels.aicommands["georgeweaponsfree"] } },
            { "georgeholdfire",               new Command { uniqueid = 23040, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeHoldFire", displayname = Labels.aicommands["georgeholdfire"] } },
            { "georgestartup",                new Command { uniqueid = 23041, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeStartUp", displayname = Labels.aicommands["georgestartup"] } },
            { "georgeshutdown",               new Command { uniqueid = 23042, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeShutdown", displayname = Labels.aicommands["georgeshutdown"] } },
            { "georgeadjustaim",              new Command { uniqueid = 23043, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeAdjustAim", displayname = Labels.aicommands["georgeadjustaim"] } },
            { "georgetadssensor",             new Command { uniqueid = 23044, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeTadsSensor", displayname = Labels.aicommands["georgetadssensor"] } },
            { "georgetadsfov",                new Command { uniqueid = 23045, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeTadsFov", displayname = Labels.aicommands["georgetadsfov"] } },
            { "georgetargetlistfilter",       new Command { uniqueid = 23046, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeTargetListFilter", displayname = Labels.aicommands["georgetargetlistfilter"] } },
            { "georgepointlistfiltermode",    new Command { uniqueid = 23047, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgePointListFilterMode", displayname = Labels.aicommands["georgepointlistfiltermode"] } },
            { "georgepointlistfilterthreat",  new Command { uniqueid = 23048, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgePointListFilterThreat", displayname = Labels.aicommands["georgepointlistfilterthreat"] } },
            { "georgetargetlistzoomin",       new Command { uniqueid = 23049, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeTargetListZoomIn", displayname = Labels.aicommands["georgetargetlistzoomin"] } },
            { "georgetargetlistzoomout",      new Command { uniqueid = 23050, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeTargetListZoomOut", displayname = Labels.aicommands["georgetargetlistzoomout"] } },
            { "georgepreviuoustarget",        new Command { uniqueid = 23051, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgePreviuousTarget", displayname = Labels.aicommands["georgepreviuoustarget"] } },
            { "georgenexttarget",             new Command { uniqueid = 23052, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeNextTarget", displayname = Labels.aicommands["georgenexttarget"] } },
            { "georgeexitlist",               new Command { uniqueid = 23053, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeExitList", displayname = Labels.aicommands["georgeexitlist"] } },
            ...
            { "georgepreviousitem",           new Command { uniqueid = 23060, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgePreviousItem", displayname = Labels.aicommands["georgepreviousitem"] } },
            { "georgenextitem",               new Command { uniqueid = 23061, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeNextItem", displayname = Labels.aicommands["georgenextitem"] } },
            { "georgelistitemselect",         new Command { uniqueid = 23062, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeListItemSelect", displayname = Labels.aicommands["georgelistitemselect"] } },
            ...
            { "georgeareaselect",             new Command { uniqueid = 23066, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeAreaSelect", displayname = Labels.aicommands["georgeareaselect"] } },
            { "georgepointselect",            new Command { uniqueid = 23067, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgePointSelect", displayname = Labels.aicommands["georgepointselect"] } },
            { "georgemacroaddtwotargetstrack",   new Command { uniqueid = 23068, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeMacroAddTwoTargetsTrack", displayname = Labels.aicommands["georgemacroaddtwotargetstrack"] } },
            { "georgemacroaddthreetargetstrack", new Command { uniqueid = 23069, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeMacroAddThreeTargetsTrack", displayname = Labels.aicommands["georgemacroaddthreetargetstrack"] } },
            { "georgemacroaddfourtargetstrack",  new Command { uniqueid = 23070, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeMacroAddFourTargetsTrack", displayname = Labels.aicommands["georgemacroaddfourtargetstrack"] } },
            { "georgelastfoundtarget",        new Command { uniqueid = 23071, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeLastFoundTarget", displayname = Labels.aicommands["georgelastfoundtarget"] } },
            { "georgemacrotrackengage",       new Command { uniqueid = 23072, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeMacroTrackEngage", displayname = Labels.aicommands["georgemacrotrackengage"] } },
            { "georgemacroselectgun",         new Command { uniqueid = 23073, category = CommandCategories.AH64D_GeorgeAI, eventnumber = 4000, dcsid = "wMsgGeorgeMacroSelectGun", displayname = Labels.aicommands["georgemacroselectgun"] } },
            ...
            { "wMsgKneeboardDictateStart" ,          new Command { uniqueid = 24001, category = CommandCategories.kneeboard,    eventnumber = 4000,  dcsid = "wMsgKneeboardDictateStart"   } },
            { "wMsgKneeboardDictateStop" ,           new Command { uniqueid = 24002, category = CommandCategories.kneeboard,    eventnumber = 4000,  dcsid = "wMsgKneeboardDictateStop"   } },
            { "wMsgKneeboardCorrection" ,            new Command { uniqueid = 24003, category = CommandCategories.kneeboard,    eventnumber = 4000,  dcsid = "wMsgKneeboardCorrection"   } },
            { "wMsgKneeboardClearNotes" ,            new Command { uniqueid = 24004, category = CommandCategories.kneeboard,    eventnumber = 4000,  dcsid = "wMsgKneeboardClearNotes"   } },
            { "wMsgKneeboardShowNotes" ,             new Command { uniqueid = 24005, category = CommandCategories.kneeboard,    eventnumber = 4000,  dcsid = "wMsgKneeboardShowNotes"   } },
            { "wMsgKneeboardShowLog" ,               new Command { uniqueid = 24006, category = CommandCategories.kneeboard,    eventnumber = 4000,  dcsid = "wMsgKneeboardShowLog"   } },
            { "wMsgKneeboardNextTab" ,               new Command { uniqueid = 24007, category = CommandCategories.kneeboard,    eventnumber = 4000,  dcsid = "wMsgKneeboardNextTab"   } },
            { "wMsgKneeboardPreviousTab" ,           new Command { uniqueid = 24008, category = CommandCategories.kneeboard,    eventnumber = 4000,  dcsid = "wMsgKneeboardPreviousTab"   } },
