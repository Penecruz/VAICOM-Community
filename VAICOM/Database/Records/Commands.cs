...
namespace VAICOM
{
    namespace Database
    {
        ...
        public static partial class Commands
        {
            ...
            { "georgesearchtargets" ,   new Command { uniqueid = 00006, category = CommandCategories.cockpit, eventnumber = 32001, dcsid = "iCommandGeorgeAI_SearchTargets", displayname = Labels.aicommands["georgesearchtargets"], hasparameter = false } },
            { "georgeengagemytarget" ,  new Command { uniqueid = 00007, category = CommandCategories.cockpit, eventnumber = 32002, dcsid = "iCommandGeorgeAI_EngageMyTarget", displayname = Labels.aicommands["georgeengagemytarget"], hasparameter = false } },
            { "georgeceasefire" ,       new Command { uniqueid = 00008, category = CommandCategories.cockpit, eventnumber = 32003, dcsid = "iCommandGeorgeAI_CeaseFire", displayname = Labels.aicommands["georgeceasefire"], hasparameter = false } },
