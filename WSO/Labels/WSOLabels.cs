...
namespace VAICOM.Extensions.WSO
{
    public static partial class Labels
    {
        ...
        public static Dictionary<string, string> aicommands = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "wMsgWSO_Ground_CMS_ChaffSingle", "WSO Ground Chaff Dispense Single" },
            { "wMsgWSO_Ground_CMS_ChaffDouble", "WSO Ground Chaff Dispense Double" },
            { "wMsgWSO_Ground_IFF_InsertM4Codes", "WSO Ground Insert M4 Codes" },
