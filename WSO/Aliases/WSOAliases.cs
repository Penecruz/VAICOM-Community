...
namespace VAICOM.Extensions.WSO
{
    public static class Aliases
    {
        ...
        public static Dictionary<string, string> aicommands = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "Focus Target", "wMsgWSO_Radar_FocusTarget_Direct" },
            { "Lock Target", "wMsgWSO_Radar_LockTarget_Direct" },
            ...
            { "Divert To Airfield", "wMsgWSO_Navigation_Divert_LatLong" },
            { "Divert To Asset", "wMsgWSO_Navigation_Divert_LatLong" },
            ...
            { "Ground Chaff Dispense Single", "wMsgWSO_Ground_CMS_ChaffSingle" },
            { "Ground Chaff Dispense Double", "wMsgWSO_Ground_CMS_ChaffDouble" },
            { "Ground Insert M4 Codes", "wMsgWSO_Ground_IFF_InsertM4Codes" },
