...
namespace VAICOM.Extensions.CPG
{
    public static partial class Aliases
    {
        ...
        public static Dictionary<string, string> aicommands = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "George start up the systems",                 "georgeapuonly"                 },
            { "George shutdown to the A P U",                "georgeapuonly"                 },
            { "George Start Engines Idle",                   "georgestartupenginesidle"      },
            { "George bring engines to idle",                "georgestartupenginesidle"      },
            { "George Start Engines Fly",                    "georgestartupenginesfly"       },
            { "George set engines to fly",                   "georgestartupenginesfly"       },
            { "George Full Start Up",                        "georgestartupfull"             },
            { "George start everything up",                  "georgestartupfull"             },
            { "George Full Shutdown",                        "georgeshutdownfull"            },
            { "George shut everything down",                 "georgeshutdownfull"            },
            ...
            { "George Increase Speed",                       "georgespeedup"                 },
            { "George Slow Down",                            "georgeslowdown"                },
            { "George Decrease Speed",                       "georgeslowdown"                },
            ...
            { "George orbit line of sight",                  "georgeorbitoverhead"           },
            ...
            { "George fire when fired upon",                 "georgereturnfire"              },
            { "George Evade Off",                            "georgeevadeoff"                },
            { "George No Evasion",                           "georgeevadeoff"                },
            { "George do not evade",                         "georgeevadeoff"                },
            { "George Evade Level",                          "georgeevadelevel"              },
            { "George evade at this altitude",               "georgeevadelevel"              },
            { "George Evade Vertical",                       "georgeevadevertical"           },
            { "George evade while descending",               "georgeevadevertical"           },
            { "George Evade Mask",                           "georgeevademask"               },
            { "George evade by masking",                     "georgeevademask"               },
            { "George Threat Warnings On",                   "georgethreatwarningson"        },
            { "George warn me of threats",                   "georgethreatwarningson"        },
            { "George call out any threats",                 "georgethreatwarningson"        },
            { "George Threat Warnings Off",                  "georgethreatwarningsoff"       },
            { "George no more threat warnings",              "georgethreatwarningsoff"       },
            ...
            { "George set countermeasures to auto",          "georgecmwsauto"                },
            { "George Countermeasures Bypass",               "georgecmwsbypass"              },
            { "George set countermeasures to bypass",        "georgecmwsbypass"              },
            ...
            { "George Slide Left",                           "georgehoverleft"               },
            { "George Move Right",                           "georgehoverright"              },
            { "George Slide Right",                           "georgehoverright"              },
